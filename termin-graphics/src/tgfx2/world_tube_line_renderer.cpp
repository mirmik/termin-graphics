...
namespace tgfx {
    namespace {
        ...
        constexpr const char* WORLD_TUBE_LINE_CAP_SHADER_UUID = "termin-engine-world-tube-line-cap";
        constexpr const char* WORLD_TUBE_LINE_LIT_SHADER_UUID = "termin-engine-world-tube-line-lit";
        ...
        void bind_tube_line_shader(RenderContext2& ctx,
            ...
            ctx.bind_uniform_data(TUBE_LINE_DRAW_RESOURCE, &draw_data, static_cast<uint32_t>(sizeof(draw_data)));
        }
    ...
    bool WorldTubeLineRenderer::ensure_resources(RenderContext2& ctx, int sides) {
        ...
        const bool body_ready = line_renderer::ensure_shader_pair(device,
                                                                  body_shader_handle_,
        ...
        const bool cap_ready = line_renderer::ensure_shader_pair(device,
                                                                 cap_shader_handle_,
        ...
        const bool lit_ready = line_renderer::ensure_fragment_shader(device,
                                                                     lit_shader_handle_,
    ...
    void WorldTubeLineRenderer::draw_polyline(RenderContext2& ctx,
        ...
        const ShaderHandle body_selected_vertex_shader =
            params.body_vertex_shader ? params.body_vertex_shader : body_vertex_shader_;
        const ShaderHandle body_selected_fragment_shader =
        ...
        const tc_shader* body_selected_layout =
            params.body_shader_layout ? params.body_shader_layout : tc_shader_get(body_shader_handle_);
        ...
        const ShaderHandle cap_selected_vertex_shader =
            params.cap_vertex_shader ? params.cap_vertex_shader : cap_vertex_shader_;
        ...
        const tc_shader* cap_selected_layout =
            params.cap_shader_layout ? params.cap_shader_layout : tc_shader_get(cap_shader_handle_);
