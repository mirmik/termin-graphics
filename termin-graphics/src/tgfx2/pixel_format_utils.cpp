...
bool is_srgb_format(PixelFormat format) {
    return format == PixelFormat::RGBA8_sRGB ||
...
PixelFormat pixel_format_for_encoding(
    ...
    switch (storage_format) {
        case PixelFormat::RGBA8_UNorm:
        case PixelFormat::RGBA8_sRGB:
            return encoding == TextureEncoding::SRGB
        ...
        default:
            ...
            // remain Linear.
            return encoding == TextureEncoding::Linear
                ? storage_format
                : PixelFormat::Undefined;
    }
}

PixelFormat pixel_format_for_tc_texture(
    ...
    switch (storage_format) {
        case TC_TEXTURE_RGBA8:    base_format = PixelFormat::RGBA8_UNorm; break;
        case TC_TEXTURE_RGB8:     base_format = PixelFormat::RGB8_UNorm; break;
        case TC_TEXTURE_RG8:      base_format = PixelFormat::RG8_UNorm; break;
        case TC_TEXTURE_R8:       base_format = PixelFormat::R8_UNorm; break;
        case TC_TEXTURE_RGBA16F:  base_format = PixelFormat::RGBA16F; break;
        case TC_TEXTURE_RGB16F:   base_format = PixelFormat::RGBA16F; break;
        case TC_TEXTURE_DEPTH24:  base_format = PixelFormat::D24_UNorm_S8_UInt; break;
        case TC_TEXTURE_DEPTH32F: base_format = PixelFormat::D32F; break;
        case TC_TEXTURE_R16F:     base_format = PixelFormat::R16F; break;
        case TC_TEXTURE_R32F:     base_format = PixelFormat::R32F; break;
    }
...
std::string_view pixel_format_name(PixelFormat format) {
    switch (format) {
        ...
        case PixelFormat::RGBA8_sRGB:        return "rgba8_srgb";
        case PixelFormat::BGRA8_sRGB:        return "bgra8_srgb";
...
PixelFormat pixel_format_from_name(std::string_view name, PixelFormat fallback) {
    ...
    if (name == "rgba8_srgb") return PixelFormat::RGBA8_sRGB;
    if (name == "bgra8_srgb") return PixelFormat::BGRA8_sRGB;
