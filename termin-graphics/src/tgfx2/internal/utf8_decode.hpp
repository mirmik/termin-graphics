    ...
    namespace internal {
        ...
        inline uint32_t utf8_decode(std::string_view s, size_t& i) {
            ...
            if ((b0 & 0xF0) == 0xE0) {
                ...
                i += 3;
                return (static_cast<uint32_t>(b0 & 0x0F) << 12) | (static_cast<uint32_t>(b1) << 6) |
            ...
            if ((b0 & 0xF8) == 0xF0) {
                ...
                i += 4;
                return (static_cast<uint32_t>(b0 & 0x07) << 18) | (static_cast<uint32_t>(b1) << 12) |
                       (static_cast<uint32_t>(b2) << 6) | static_cast<uint32_t>(b3);
            }
            i += 1;
            return 0xFFFD;
        }
