...
int main(int argc, char** argv) {
    if (argc != 2 || (std::strcmp(argv[1], "enabled") != 0 && std::strcmp(argv[1], "disabled") != 0)) {
    ...
    if (counter.load(std::memory_order_relaxed) != (expected_enabled ? 7u : 0u)) {
    ...
    if ((expected_enabled && measured_us == 0) || (!expected_enabled && measured_us != 0)) {
