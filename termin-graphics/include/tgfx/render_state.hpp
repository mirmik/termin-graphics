...
namespace termin {
    ...
    struct RenderState {
        ...
        RenderState(PolygonMode polygon_mode_,
                    bool cull_,
                    bool depth_test_,
                    bool depth_write_,
                    bool blend_,
        ...
        bool operator==(const RenderState& other) const {
            return polygon_mode == other.polygon_mode && cull == other.cull && depth_test == other.depth_test &&
                   depth_write == other.depth_write && blend == other.blend && blend_src == other.blend_src &&
