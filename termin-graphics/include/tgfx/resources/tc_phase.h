...
#define TC_PHASE_EDITOR_DEBUG_TRANSPARENT (UINT64_C(1) << TC_PHASE_INDEX_EDITOR_DEBUG_TRANSPARENT)
#define TC_PHASE_ALL UINT64_MAX
#define TC_PHASE_PROJECT_CAPACITY (TC_PHASE_INDEX_COUNT - TC_PHASE_INDEX_USER_FIRST)
