...
TGFX_API bool tc_shader_abi_name_matches(const tc_shader_abi_resource_decl* decl, const char* name);
TGFX_API bool tc_shader_abi_name_is_legacy_alias(const tc_shader_abi_resource_decl* decl, const char* name);
TGFX_API bool tc_shader_abi_binding_matches(const tc_shader_abi_resource_decl* decl,
                                            const tc_shader_resource_binding* binding);
TGFX_API const tc_shader_resource_binding* tc_shader_abi_find_resource_binding(const tc_shader* shader, uint32_t id);
