...
namespace tgfx {
    ...
    public:
        ...
        static std::unique_ptr<GraphicsHost> adopt_application_device(std::unique_ptr<IRenderDevice> device);
        ...
        static std::unique_ptr<GraphicsHost> adopt_isolated_device(std::unique_ptr<IRenderDevice> device);
        ...
        bool owns_application_domain() const {
            return interop_claimed_;
        }
