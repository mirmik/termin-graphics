...
namespace termin {
    ...
    public:
         ...
         */
        void flush(tgfx::RenderContext2* ctx2,
         ...
         */
        void
        flush_depth(tgfx::RenderContext2* ctx2, const Mat44& view_matrix, const Mat44& proj_matrix, bool blend = true);

        /**
         * Number of lines accumulated (no depth test).
         */
        size_t line_count() const {
            return line_vertices.size() / 14;
        } // 2 vertices * 7 floats
        ...
        size_t triangle_count() const {
            return tri_vertices.size() / 21;
        } // 3 vertices * 7 floats

        /**
         * Number of lines accumulated (with depth test).
         */
        size_t line_count_depth() const {
            return line_vertices_depth.size() / 14;
        }

        /**
         * Number of triangles accumulated (with depth test).
         */
        size_t triangle_count_depth() const {
            return tri_vertices_depth.size() / 21;
        }
    ...
    private:
        ...
        void _flush_buffers(tgfx::RenderContext2* ctx2,
