...
namespace tgfx {
    ...
    TGFX2_API TextureEncoding texture_encoding_for_format(PixelFormat format);
    TGFX2_API uint32_t pixel_format_byte_size(PixelFormat format);
    TGFX2_API PixelFormat pixel_format_for_encoding(PixelFormat storage_format, TextureEncoding encoding);
    TGFX2_API PixelFormat pixel_format_for_tc_texture(tc_texture_format storage_format, tc_texture_encoding encoding);
    TGFX2_API std::string_view pixel_format_name(PixelFormat format);
    TGFX2_API PixelFormat pixel_format_from_name(std::string_view name,
