...
namespace tgfx {
    ...
    public:
        ...
        void bind_vertex_buffer(uint32_t slot, BufferHandle buffer, uint64_t offset) override;
        void bind_index_buffer(BufferHandle buffer, IndexType type, uint64_t offset) override;
        ...
        void copy_buffer(
            BufferHandle src, BufferHandle dst, uint64_t size, uint64_t src_offset, uint64_t dst_offset) override;
