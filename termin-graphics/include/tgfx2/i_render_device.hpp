...
namespace tgfx {
    ...
    public:
        ...
        virtual ResourceSetHandle create_bound_resource_set(const BoundResourceSetDesc& desc) = 0;
        ...
        virtual TextureHandle register_external_texture(uintptr_t native_handle, const TextureDesc& desc) {
            (void)native_handle;
            (void)desc;
            throw std::runtime_error("register_external_texture: not supported on this backend");
        }
        virtual bool begin_external_texture_access(TextureHandle, const ExternalTextureAccessDesc&) {
            throw std::runtime_error("begin_external_texture_access: not supported on this backend");
        }
        virtual bool end_external_texture_access(TextureHandle) {
            throw std::runtime_error("end_external_texture_access: not supported on this backend");
        }
        virtual BufferHandle register_external_buffer(uintptr_t native_handle, const BufferDesc& desc) {
            (void)native_handle;
            (void)desc;
        ...
        // offset.
        virtual BufferHandle transient_vertex_buffer() {
            return {};
        }

        virtual uint64_t transient_vertex_write(const void* data, uint32_t size) {
            (void)data;
            (void)size;
            return UINT64_MAX;
        }
        ...
        virtual bool
        transient_uniform_write(const void* data, uint32_t size, BufferHandle& out_buffer, uint32_t& out_offset) {
            (void)data;
            (void)size;
            out_buffer = {};
            out_offset = 0;
        ...
        // Filtering: linear.
        virtual void
        blit_to_texture(TextureHandle dst, TextureHandle src, termin::Bounds2i src_rect, termin::Bounds2i dst_rect) {
            (void)dst;
            (void)src;
            (void)src_rect;
            (void)dst_rect;
        ...
        virtual BufferHandle ring_ubo_handle() const {
            return {};
        }
        virtual bool ring_ubo_write(const void* /*data*/, uint32_t /*size*/, uint32_t& /*offset*/) {
            return false;
        }
        virtual uint32_t ubo_alignment() const {
            return 1;
        }
        ...
        virtual bool ensure_tc_shader(tc_shader* /*shader*/, ShaderHandle* /*out_vs*/, ShaderHandle* /*out_fs*/) {
            return false;
        }
