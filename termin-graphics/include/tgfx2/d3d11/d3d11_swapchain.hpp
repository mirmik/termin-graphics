...
namespace tgfx {
    ...
    public:
        D3D11Swapchain(D3D11RenderDevice& device,
                       HWND hwnd,
                       uint32_t width,
                       uint32_t height,
        ...
        TextureHandle backbuffer_texture() const {
        ...
        IDXGISwapChain* native_swapchain() const {
            return swapchain_.Get();
        }
        IDXGISwapChain1* native_swapchain1() const {
            return swapchain_.Get();
        }
        ...
        PresentationMode presentation_mode() const {
            return presentation_.effective_mode;
        }
        bool tearing_supported() const {
            return presentation_.tearing_supported;
        }
        bool tearing_enabled() const {
            return presentation_.allow_tearing;
        }
