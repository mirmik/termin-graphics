...
namespace tgfx_bindings {
    ...
    void bind_immediate(nb::module_& m) {
        nb::class_<ImmediateRenderer>(m, "ImmediateRenderer")
            .def(nb::init<>())
            .def("begin", &ImmediateRenderer::begin, "Clear all accumulated primitives")
            // Basic primitives
            .def("line",
                 &ImmediateRenderer::line,
                 nb::arg("start"),
                 nb::arg("end"),
                 nb::arg("color"),
                 nb::arg("depth_test") = false)
            .def("triangle",
                 &ImmediateRenderer::triangle,
                 nb::arg("p0"),
                 nb::arg("p1"),
                 nb::arg("p2"),
                 nb::arg("color"),
            ...
            .def(
                ...
                [](ImmediateRenderer& self,
                   ...
                   bool depth_test) {
                    ...
                    self.triangles(
                        vertices.data(), vertex_count, indices.data(), triangle_count, colors.data(), depth_test);
                },
                nb::arg("vertices"),
                nb::arg("indices"),
                nb::arg("colors"),
            ...
            .def(
                ...
                [](ImmediateRenderer& self,
                   ...
                   bool depth_test) {
                    size_t vertex_count = vertices.shape(0);
                    size_t triangle_count = indices.shape(0);
                    self.triangles(vertices.data(), vertex_count, indices.data(), triangle_count, color, depth_test);
                },
                nb::arg("vertices"),
                nb::arg("indices"),
                nb::arg("color"),
            ...
            // Wireframe
            .def("polyline",
                 &ImmediateRenderer::polyline,
                 nb::arg("points"),
                 nb::arg("color"),
                 nb::arg("closed") = false,
                 nb::arg("depth_test") = false)
            .def("circle",
                 &ImmediateRenderer::circle,
                 nb::arg("center"),
                 nb::arg("normal"),
                 nb::arg("radius"),
                 nb::arg("color"),
                 ...
                 nb::arg("depth_test") = false)
            .def("arrow",
                 &ImmediateRenderer::arrow,
                 nb::arg("origin"),
                 nb::arg("direction"),
                 nb::arg("length"),
                 nb::arg("color"),
                 nb::arg("head_length") = 0.2,
                 nb::arg("head_width") = 0.1,
                 nb::arg("depth_test") = false)
            .def("box",
                 &ImmediateRenderer::box,
                 nb::arg("min_pt"),
                 nb::arg("max_pt"),
                 nb::arg("color"),
                 nb::arg("depth_test") = false)
            .def("cylinder_wireframe",
                 &ImmediateRenderer::cylinder_wireframe,
                 nb::arg("start"),
                 nb::arg("end"),
                 nb::arg("radius"),
                 nb::arg("color"),
            ...
            .def("sphere_wireframe",
                 &ImmediateRenderer::sphere_wireframe,
                 nb::arg("center"),
                 nb::arg("radius"),
                 nb::arg("color"),
                 nb::arg("segments") = 16,
            ...
            .def("capsule_wireframe",
                 &ImmediateRenderer::capsule_wireframe,
                 nb::arg("start"),
                 nb::arg("end"),
                 nb::arg("radius"),
                 nb::arg("color"),
            ...
            // Solid
            .def("cylinder_solid",
                 &ImmediateRenderer::cylinder_solid,
                 nb::arg("start"),
                 nb::arg("end"),
                 nb::arg("radius"),
                 nb::arg("color"),
            ...
            .def(
                ...
                [](ImmediateRenderer& self,
                   ...
                   bool depth_test) {
                    self.torus_solid(
                        TorusSolidSpec{center, axis, major_radius, minor_radius, major_segments, minor_segments},
                        color,
                        depth_test);
                },
                nb::arg("center"),
                ...
                nb::arg("minor_radius"),
                nb::arg("color"),
                nb::arg("major_segments") = 32,
                nb::arg("minor_segments") = 12,
                nb::arg("depth_test") = false)
            .def(
                "arrow_solid",
                [](ImmediateRenderer& self,
                   ...
                   bool depth_test) {
                    self.arrow_solid(
                        ArrowSolidSpec{
                            origin, direction, length, shaft_radius, head_radius, head_length_ratio, segments},
                        color,
                        depth_test);
                },
                nb::arg("origin"),
                ...
                nb::arg("length"),
                nb::arg("color"),
                nb::arg("shaft_radius") = 0.03,
                nb::arg("head_radius") = 0.06,
                nb::arg("head_length_ratio") = 0.25,
                nb::arg("segments") = 16,
                nb::arg("depth_test") = false)
            ...
            .def(
                ...
                [](ImmediateRenderer& self,
                   ...
                   const Mat44& proj,
                   bool depth_test,
                   bool blend) { self.flush(ctx2, view, proj, depth_test, blend); },
                nb::arg("ctx2"),
                nb::arg("view_matrix"),
                nb::arg("proj_matrix"),
                nb::arg("depth_test") = true,
            ...
            .def(
                ...
                [](ImmediateRenderer& self,
                   ...
                   const Mat44& view,
                   const Mat44& proj,
                   bool blend) { self.flush_depth(ctx2, view, proj, blend); },
                nb::arg("ctx2"),
                nb::arg("view_matrix"),
                nb::arg("proj_matrix"),
                nb::arg("blend") = true)
