...
namespace termin {
    ...
    PythonRenderItem
    PythonRenderItem::mesh(const TcMesh& mesh, tc_material_phase* phase, int geometry_id, size_t submesh_index) {
    ...
    void bind_drawable(nb::module_& m) {
        ...
        nb::class_<PythonRenderItem>(m, "RenderItem")
            ...
            .def_static(
                "mesh",
                [](const TcMesh& mesh, nb::object phase_obj, int geometry_id, size_t submesh_index) {
            ...
            .def_prop_ro("kind", [](const PythonRenderItem& self) { return self.item.kind; })
            .def_prop_ro("geometry_id", [](const PythonRenderItem& self) { return self.item.geometry_id; });
    }
