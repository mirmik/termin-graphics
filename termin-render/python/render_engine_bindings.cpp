...
namespace termin {
    ...
    void bind_render_engine(nb::module_& m) {
        nb::class_<RenderEngine>(m, "RenderEngine")
            .def(nb::init<>())
            .def(
                "set_graphics_host", &RenderEngine::set_graphics_host, nb::arg("graphics_host"), nb::keep_alive<1, 2>())
            ...
            .def(
                ...
                [](RenderEngine& self,
                   ...
                   bool dev_compile_enabled) {
                    self.configure_shader_artifacts(artifact_root, cache_root, compiler_path, dev_compile_enabled);
                },
                nb::arg("artifact_root"),
                nb::arg("cache_root"),
                nb::arg("compiler_path") = "",
                nb::arg("dev_compile_enabled") = false)
            .def_prop_ro("tgfx2_ctx", &RenderEngine::tgfx2_ctx, nb::rv_policy::reference_internal)
            .def_prop_ro("tgfx2_device", &RenderEngine::tgfx2_device, nb::rv_policy::reference_internal)
            .def(
                ...
                [](RenderEngine& self,
                   ...
                   const std::string& default_render_target) {
                    ...
                    render_scene_pipeline_offscreen(self,
                                                    pipeline,
                                                    scene_ref.handle(),
        ...
        nb::class_<RenderTargetContext>(m, "RenderTargetContext")
            ...
            .def_prop_rw(
                "view",
                [](const RenderTargetContext& context) -> const RenderCamera* { return context.view.primary_view(); },
