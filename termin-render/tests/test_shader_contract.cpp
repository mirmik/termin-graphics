...
namespace {
    ...
    tc_shader_resource_requirement material_requirement() {
        ...
        std::snprintf(requirement.name, sizeof(requirement.name), "%s", TC_SHADER_RESOURCE_MATERIAL);
    ...
    tc_shader_resource_binding material_binding() {
        ...
        std::snprintf(binding.name, sizeof(binding.name), "%s", TC_SHADER_RESOURCE_MATERIAL);
    ...
    tc_shader_contract_desc contract_desc(const tc_shader_resource_requirement* requirement,
