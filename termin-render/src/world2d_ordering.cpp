...
bool order_less(
    const World2DOrderEntry& lhs,
    const World2DOrderEntry& rhs,
    World2DDepthSortMode depth_mode)
{
    ...
    if (depth_mode != World2DDepthSortMode::Disabled &&
        lhs.key.spatial_depth != rhs.key.spatial_depth) {
...
bool sort_world2d_order_entries(
