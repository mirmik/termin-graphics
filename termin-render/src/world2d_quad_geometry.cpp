...
std::array<Vec3, 4> world2d_quad_corners(
...
bool ray_intersects_world2d_quad(
    ...
    double* out_distance)
{
    ...
    const bool hit_first = ray_intersects_triangle(
        ray_origin, ray_direction, corners[0], corners[1], corners[2], first);
    const bool hit_second = ray_intersects_triangle(
        ray_origin, ray_direction, corners[0], corners[2], corners[3], second);
