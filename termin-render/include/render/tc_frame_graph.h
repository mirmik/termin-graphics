...
// Count/fill enumeration: both functions return the complete count. Passing
// out_names == NULL queries the required capacity.
TC_API size_t tc_frame_graph_get_alias_group(tc_frame_graph* fg,
                                             const char* resource,
