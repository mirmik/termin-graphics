...
TC_API bool tc_pipeline_template_set_payload(tc_pipeline_template* pipeline_template,
...
TC_API size_t tc_pipeline_template_serialize(const tc_pipeline_template* pipeline_template,
                                             uint8_t* output,
                                             size_t capacity);
TC_API tc_pipeline_template_handle tc_pipeline_template_deserialize(const char* uuid, const uint8_t* data, size_t size);
