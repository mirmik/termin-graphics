...
namespace termin {
    ...
    // normalized to int32 0/1. Color semantic types require exact enum/type matches;
    // SrgbColor is decoded to LinearColor once. Returns false without touching dst on
