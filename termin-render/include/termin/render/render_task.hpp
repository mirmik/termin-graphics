...
namespace termin {
    ...
    struct RENDER_CORE_API RenderTask {
        ...
        std::array<tc_shader_handle, RenderItemTaskShaderPlan::MAX_SHADER_USAGES> shader_usages{};
        std::array<TcShader, RenderItemTaskShaderPlan::MAX_SHADER_USAGES> owned_shader_usages{};
    ...
    public:
        ...
        template <typename T, typename... Args> T& emplace_extension(Args&&... args) {
