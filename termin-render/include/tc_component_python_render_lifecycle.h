...
typedef void (*tc_py_render_attach_fn)(void* py_self, const tc_render_attachment_context* context);
typedef void (*tc_py_render_prepare_fn)(void* py_self, const tc_render_prepare_context* context);
typedef void (*tc_py_render_detach_fn)(void* py_self, const tc_render_attachment_context* context);
...
TC_API void tc_component_set_python_render_lifecycle_callbacks(const tc_python_render_lifecycle_callbacks* callbacks);
