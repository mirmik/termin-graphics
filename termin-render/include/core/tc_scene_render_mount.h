// tc_scene_render_mount.h - Render mount extension (pipeline templates + viewport configs)
...
// The scene mount is a strong owner of canonical compiled pipeline templates.
TC_API bool tc_scene_add_pipeline_template(tc_scene_handle h, tc_pipeline_template_handle pipeline_template);
TC_API bool tc_scene_remove_pipeline_template(tc_scene_handle h, tc_pipeline_template_handle pipeline_template);
...
TC_API tc_pipeline_template_handle tc_scene_pipeline_template_at(tc_scene_handle h, size_t index);
