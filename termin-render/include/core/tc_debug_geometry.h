...
TC_API tc_debug_geometry_type_id tc_debug_geometry_type_register(
    const char* stable_id,
    const char* display_name,
    const char* category,
    bool default_enabled
...
TC_API bool tc_debug_geometry_type_at(
    size_t index,
    tc_debug_geometry_type_desc* out_desc
);
TC_API void tc_debug_geometry_registry_clear(void);

TC_API bool tc_scene_debug_geometry_enabled(
    tc_scene_handle scene,
    tc_debug_geometry_type_id type_id
);
TC_API bool tc_scene_debug_geometry_set_enabled(
    tc_scene_handle scene,
    tc_debug_geometry_type_id type_id,
    bool enabled
);

TC_API bool tc_render_prepare_context_debug_geometry(
...
TC_API bool tc_debug_geometry_drawer_line(
...
TC_API const tc_debug_geometry_primitive* tc_scene_debug_geometry_primitive_at(
    tc_scene_handle scene,
    size_t index
);
