...
TC_API bool tc_render_lifecycle_capability_attach(
    tc_component* component,
    const tc_render_lifecycle_vtable* vtable,
    void* userdata
);
TC_API void tc_render_lifecycle_capability_detach(tc_component* component);
TC_API const tc_render_lifecycle_capability* tc_render_lifecycle_capability_get(
...
TC_API void tc_render_lifecycle_notify_component_registered(
    tc_component* component,
    const tc_render_attachment_context* context
);
TC_API void tc_render_lifecycle_notify_component_unregistering(
    tc_component* component,
    const tc_render_attachment_context* context
);
TC_API void tc_render_lifecycle_notify_scene_attach(
    tc_scene_handle scene,
    const tc_render_attachment_context* context
);
TC_API void tc_render_lifecycle_prepare_scene(
    tc_scene_handle scene,
    const tc_render_prepare_context* context
);
TC_API void tc_render_lifecycle_notify_scene_detach(
    tc_scene_handle scene,
    const tc_render_attachment_context* context
);
