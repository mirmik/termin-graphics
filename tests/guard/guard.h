...
// Р’СЃСЏ СЃСЂРµРґР° РїСЂРѕРІРµСЂРєРё РІ РѕРґРЅРѕР№ СЃС‚СЂСѓРєС‚СѓСЂРµ
...
// Р“Р»РѕР±Р°Р»СЊРЅС‹Р№ (РЅР° РїСЂРѕС†РµСЃСЃ) СЌРєР·РµРјРїР»СЏСЂ СЃСЂРµРґС‹, СЂРµР°Р»РёР·РѕРІР°РЅРЅС‹Р№ С‡РµСЂРµР·
// СЃС‚Р°С‚РёС‡РµСЃРєСѓСЋ Р»РѕРєР°Р»СЊРЅСѓСЋ РїРµСЂРµРјРµРЅРЅСѓСЋ РІРЅСѓС‚СЂРё inline-С„СѓРЅРєС†РёРё
...
// РњР°РєСЂРѕСЃС‹-Р°Р»РёР°СЃС‹, С‡С‚РѕР±С‹ СЃС‚Р°СЂС‹Р№ РєРѕРґ РїСЂРѕРґРѕР»Р¶Р°Р» СЂР°Р±РѕС‚Р°С‚СЊ РєР°Рє СЂР°РЅСЊС€Рµ
#define guard_check_error_msg (guard_check_env().error_msg)

// РќР°С‡Р°Р»Рѕ "РѕРєСЂСѓР¶РµРЅРёСЏ" РїСЂРѕРІРµСЂРєРё: РѕС‡РёС‰Р°РµРј СЃС‚СЂРѕРєСѓ Рё Р·Р°РїСѓСЃРєР°РµРј try-Р±Р»РѕРє
#define GUARD_CHECK_ENV_START()                                                \
    if (guard_check_error_msg.clear(), true)                                   \
        try

// Р’РµС‚РєР° РѕР±СЂР°Р±РѕС‚РєРё РѕС€РёР±РєРё (РїРѕСЃР»Рµ РІС‹Р±СЂРѕСЃР° guard_check_exception)
#define GUARD_CHECK_ENV_ERROR_HANDLER() catch (const guard_check_exception &)

// РЈСЃС‚Р°РЅРѕРІРєР° СЃРѕРѕР±С‰РµРЅРёСЏ РѕР± РѕС€РёР±РєРµ (РїРµСЂРµР·Р°РїРёСЃС‹РІР°РµС‚ РїСЂРµРґС‹РґСѓС‰РёР№ С‚РµРєСЃС‚)
inline void GUARD_CHECK_ENV_RAISE_SET(const std::string &msg)
{
    guard_check_error_msg = msg;
}

// РџРµСЂРµС…РѕРґ РЅР°Р·Р°Рґ РІ С‚РѕС‡РєСѓ GUARD_CHECK_ENV_START()
...
// Р”РѕР±Р°РІР»РµРЅРёРµ СЃРѕРѕР±С‰РµРЅРёСЏ РѕР± РѕС€РёР±РєРµ (РґР»СЏ "РјСЏРіРєРёС…" CHECK)
...
namespace guard
{
    ...
    public:
        ...
        // Р—Р°РґР°С‚СЊ РѕС‚РЅРѕСЃРёС‚РµР»СЊРЅСѓСЋ РїРѕРіСЂРµС€РЅРѕСЃС‚СЊ
        ...
        // Р—Р°РґР°С‚СЊ РјР°СЃС€С‚Р°Р± (РєР°Рє РІ doctest / Catch2)
        ...
        // Р”Р»СЏ РѕС‚Р»Р°РґРѕС‡РЅС‹С… СЃРѕРѕР±С‰РµРЅРёР№
        ...
        // РЎСЂР°РІРЅРµРЅРёРµ "С‡РёСЃР»Рѕ == Approx(...)"
...
// Р‘Р°Р·РѕРІС‹Р№ CHECK: РІС‹СЂР°Р¶РµРЅРёРµ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ РёСЃС‚РёРЅРЅС‹Рј (РјСЏРіРєРёР№, РЅРµ СЂРІС‘С‚ С‚РµСЃС‚)
...
// Р‘Р°Р·РѕРІС‹Р№ REQUIRE: РІС‹СЂР°Р¶РµРЅРёРµ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ РёСЃС‚РёРЅРЅС‹Рј (Р¶С‘СЃС‚РєРёР№, СЂРІС‘С‚ С‚РµСЃС‚)
...
// CHECK_FALSE: РІС‹СЂР°Р¶РµРЅРёРµ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ Р»РѕР¶РЅС‹Рј (РјСЏРіРєРёР№)
...
// REQUIRE_FALSE: РІС‹СЂР°Р¶РµРЅРёРµ РґРѕР»Р¶РЅРѕ Р±С‹С‚СЊ Р»РѕР¶РЅС‹Рј (Р¶С‘СЃС‚РєРёР№)
...
// Р Р°РІРµРЅСЃС‚РІРѕ: a == b (РјСЏРіРєРёР№)
...
// Р Р°РІРµРЅСЃС‚РІРѕ: a == b (Р¶С‘СЃС‚РєРёР№)
...
// РќРµСЂР°РІРµРЅСЃС‚РІРѕ: a != b (РјСЏРіРєРёР№)
...
// РќРµСЂР°РІРµРЅСЃС‚РІРѕ: a != b (Р¶С‘СЃС‚РєРёР№)
...
// РњРµРЅСЊС€Рµ: a < b (Р¶С‘СЃС‚РєРёР№)
...
// Р‘РѕР»СЊС€Рµ: a > b (Р¶С‘СЃС‚РєРёР№)
...
namespace guard::test
{
    ...
    // test_filter == nullptr -> Р·Р°РїСѓСЃРєР°С‚СЊ РІСЃРµ С‚РµСЃС‚С‹
    inline int run_all(const char *test_filter, std::ostream &os = std::cout)
    {
        ...
        // РљРѕРїРёСЂСѓРµРј Рё СЃРѕСЂС‚РёСЂСѓРµРј С‚РµСЃС‚С‹ РїРѕ С„Р°Р№Р»Сѓ, СЃС‚СЂРѕРєРµ Рё РёРјРµРЅРё
        auto tests = registry();
        ...
        for (const auto &tc : tests)
        {
            ...
            // РџРµСЂРµС…РІР°С‚С‹РІР°РµРј std::cout РЅР° РІСЂРµРјСЏ РІС‹РїРѕР»РЅРµРЅРёСЏ С‚РµСЃС‚Р°
            ...
            GUARD_CHECK_ENV_START()
            {
                ...
                {
                    // REQUIRE/FAIL Р±СЂРѕСЃР°СЋС‚ guard_check_exception вЂ” РїСЂРѕР±СЂР°СЃС‹РІР°РµРј РЅР°СЂСѓР¶Сѓ
                    throw;
                }
...
// ---------- РІРЅСѓС‚СЂРµРЅРЅСЏСЏ СЃРєР»РµР№РєР° РёРјС‘РЅ ----------
...
// ---------- РѕР±С‰РёР№ helper РґР»СЏ "СЃРґРµР»Р°С‚СЊ С„РµР№Р»" ----------
...
// ---------- РїСЂРѕРІРµСЂРєРё РёСЃРєР»СЋС‡РµРЅРёР№ ----------

// РѕР¶РёРґР°РµРј Р»СЋР±РѕРµ РёСЃРєР»СЋС‡РµРЅРёРµ (С„Р°С‚Р°Р»СЊРЅС‹Р№, Р±Р»РёР¶Рµ Рє REQUIRE_THROWS)
...
// РѕР¶РёРґР°РµРј, С‡С‚Рѕ code РєРёРЅРµС‚ РёСЃРєР»СЋС‡РµРЅРёРµ С‚РёРїР° ExType (С„Р°С‚Р°Р»СЊРЅС‹Р№)
...
// РѕР¶РёРґР°РµРј, С‡С‚Рѕ code РќРР§Р•Р“Рћ РЅРµ РєРёРґР°РµС‚ (С„Р°С‚Р°Р»СЊРЅС‹Р№)
...
// ---------- "С‚Р°Р№РјР°СѓС‚" РїРѕ РІСЂРµРјРµРЅРё РІС‹РїРѕР»РЅРµРЅРёСЏ ----------
...
// ---------- СѓРґРѕР±РЅС‹Р№ main ----------
// РџРѕРґРґРµСЂР¶РєР° С„РёР»СЊС‚СЂР°С†РёРё С‚РµСЃС‚РѕРІ РїРѕ РёРјРµРЅРё С‡РµСЂРµР· Р°СЂРіСѓРјРµРЅС‚ РєРѕРјР°РЅРґРЅРѕР№ СЃС‚СЂРѕРєРё:
