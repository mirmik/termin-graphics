...
namespace termin {
    ...
    GraphAliasPass::GraphAliasPass(std::vector<std::string> reads,
    ...
    void GraphAliasPass::register_type() {
        auto descriptor = FramePassTypeDescriptorBuilder::native<GraphAliasPass>("GraphAliasPass", "termin-render-core");
