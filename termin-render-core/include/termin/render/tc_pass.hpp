...
namespace termin {
    ...
    public:
        ...
        bool passthrough() const {
            return _c ? _c->passthrough : false;
        }
        void set_passthrough(bool v) {
            if (_c)
                _c->passthrough = v;
        }
        ...
        RENDER_CORE_API bool set_field(const std::string& field_name, const tc_value& value);
    ...
    public:
        ...
        std::string pass_name() const {
            return ref().pass_name();
        }
        void set_pass_name(const std::string& name) {
            ref().set_pass_name(name);
        }
