...
namespace tcplot_bindings {
    ...
    void bind_annotations(nb::module_& m) {
        nb::class_<tcplot::PlotAnnotationHandle>(m, "PlotAnnotationHandle")
            ...
            .def("__eq__", [](const tcplot::PlotAnnotationHandle& self, const tcplot::PlotAnnotationHandle& other) {
                return self == other;
            });
        ...
        nb::class_<tcplot::PlotDataMarker2D>(m, "PlotDataMarker2D")
            ...
            .def_prop_rw(
                "x",
                [](const tcplot::PlotDataMarker2D& self) { return self.data_position.x; },
                [](tcplot::PlotDataMarker2D& self, double value) { self.data_position.x = value; })
            .def_prop_rw(
                "y",
                [](const tcplot::PlotDataMarker2D& self) { return self.data_position.y; },
                [](tcplot::PlotDataMarker2D& self, double value) { self.data_position.y = value; })
            .def_rw("text", &tcplot::PlotDataMarker2D::text)
            .def_prop_rw(
                "callout_offset_x",
                [](const tcplot::PlotDataMarker2D& self) { return self.callout_offset.x; },
                [](tcplot::PlotDataMarker2D& self, float value) { self.callout_offset.x = value; })
            .def_prop_rw(
                "callout_offset_y",
                [](const tcplot::PlotDataMarker2D& self) { return self.callout_offset.y; },
                [](tcplot::PlotDataMarker2D& self, float value) { self.callout_offset.y = value; })
        ...
        nb::class_<tcplot::PlotDataMarkerSnapshot2D>(m, "PlotDataMarkerSnapshot2D")
            .def_ro("annotation", &tcplot::PlotDataMarkerSnapshot2D::annotation)
        ...
        nb::class_<tcplot::PlotAnnotationAction2D>(m, "PlotAnnotationAction2D")
