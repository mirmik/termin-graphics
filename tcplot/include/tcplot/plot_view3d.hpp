...
namespace tcplot {
    ...
    public:
        ...
        bool pick(float mx, float my, double* out_x, double* out_y, double* out_z, double* out_screen_dist_px);
        ...
        tgfx::TextureHandle depth_texture() const {
            return offscreen_depth_;
        }
