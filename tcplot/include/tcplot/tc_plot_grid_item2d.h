...
TCPLOT_API tc_graphic_item_handle tc_plot_grid_item2d_create(tc_visual_scene_handle owner_scene,
                                                             tc_plot_projection_handle2d projection,
...
TCPLOT_API bool tc_plot_grid_item2d_set_projection(tc_visual_scene_handle owner_scene,
                                                   tc_graphic_item_handle item,
                                                   tc_plot_projection_handle2d projection);
TCPLOT_API bool tc_plot_grid_item2d_set_ticks(tc_visual_scene_handle owner_scene,
                                              tc_graphic_item_handle item,
                                              const double* x_ticks,
                                              size_t x_tick_count,
                                              const double* y_ticks,
                                              size_t y_tick_count);
TCPLOT_API bool tc_plot_grid_item2d_set_style(tc_visual_scene_handle owner_scene,
                                              tc_graphic_item_handle item,
                                              tc_plot_grid_style2d style);
TCPLOT_API bool tc_plot_grid_item2d_snapshot(tc_visual_scene_handle owner_scene,
                                             tc_graphic_item_handle item,
...
TCPLOT_API size_t tc_plot_grid_item2d_copy_ticks(tc_visual_scene_handle owner_scene,
                                                 tc_graphic_item_handle item,
                                                 double* out_x_ticks,
                                                 size_t x_capacity,
                                                 double* out_y_ticks,
