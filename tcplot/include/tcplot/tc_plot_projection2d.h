...
static inline tc_plot_projection_handle2d tc_plot_projection_handle2d_invalid(void) {
...
static inline bool tc_plot_projection_handle2d_is_invalid(tc_plot_projection_handle2d handle) {
    return handle.scene_id == 0 || handle.index == UINT32_MAX;
}

static inline bool tc_plot_projection_handle2d_eq(tc_plot_projection_handle2d left, tc_plot_projection_handle2d right) {
...
TCPLOT_API tc_plot_projection_handle2d tc_plot_projection2d_create(tc_visual_scene_handle owner_scene,
                                                                   const tc_plot_projection_desc2d* desc);
TCPLOT_API bool tc_plot_projection2d_destroy(tc_plot_projection_handle2d handle);
TCPLOT_API bool tc_plot_projection2d_is_valid(tc_plot_projection_handle2d handle);
TCPLOT_API bool tc_plot_projection2d_matches_scene(tc_plot_projection_handle2d handle, tc_visual_scene_handle scene);
TCPLOT_API tc_visual_scene_handle tc_plot_projection2d_owner_scene(tc_plot_projection_handle2d handle);
...
TCPLOT_API bool tc_plot_projection2d_update(tc_plot_projection_handle2d handle, const tc_plot_projection_desc2d* desc);
TCPLOT_API bool tc_plot_projection2d_snapshot(tc_plot_projection_handle2d handle,
                                              tc_plot_projection_state2d* out_state);

TCPLOT_API bool tc_plot_projection_desc2d_is_valid(const tc_plot_projection_desc2d* desc);
TCPLOT_API bool tc_plot_projection_state2d_data_to_visual(const tc_plot_projection_state2d* state,
                                                          tc_plot_point2d data,
                                                          tc_plot_visual_point2d* out_visual);
TCPLOT_API bool tc_plot_projection_state2d_visual_to_data(const tc_plot_projection_state2d* state,
