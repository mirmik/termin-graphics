...
namespace tcplot {
    ...
    public:
        ...
        explicit PlotProjection2D(PlotProjectionHandle2D handle)
            : handle_(handle) {}
        ...
        PlotProjectionHandle2D handle() const {
            return handle_;
        }
    ...
    create_plot_projection2d(const termin::visual::TcVisualScene& owner_scene, const PlotFrame2D& frame);
