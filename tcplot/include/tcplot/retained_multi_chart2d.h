...
extern "C"
{
    ...
    TCPLOT_API tc_retained_multi_chart2d*
    ...
    TCPLOT_API void
    tc_retained_multi_chart2d_destroy(tc_retained_multi_chart2d* chart);

    TCPLOT_API tc_visual_scene_handle tc_retained_multi_chart2d_scene(
        const tc_retained_multi_chart2d* chart);
    TCPLOT_API tc_graphic_item_handle tc_retained_multi_chart2d_root(
        const tc_retained_multi_chart2d* chart);
    TCPLOT_API bool tc_retained_multi_chart2d_snapshot(
        const tc_retained_multi_chart2d* chart,
        tc_retained_multi_chart2d_state* out_snapshot);

    TCPLOT_API bool tc_retained_multi_chart2d_set_viewport(
        tc_retained_multi_chart2d* chart,
        tc_plot_rect2d viewport,
        float pixel_scale);
    TCPLOT_API bool tc_retained_multi_chart2d_set_panel_count(
    ...
    TCPLOT_API bool tc_retained_multi_chart2d_set_panel_layout(
        tc_retained_multi_chart2d* chart,
        float panel_height,
        float panel_gap);
    TCPLOT_API bool tc_retained_multi_chart2d_set_scroll_offset(
        tc_retained_multi_chart2d* chart, float scroll_offset);
    TCPLOT_API bool tc_retained_multi_chart2d_set_shared_x(
        tc_retained_multi_chart2d* chart, double x_min, double x_max);
    TCPLOT_API bool tc_retained_multi_chart2d_set_theme(
        tc_retained_multi_chart2d* chart, const tc_chart2d_theme* theme);

    TCPLOT_API tc_multi_chart_panel_handle2d
    tc_retained_multi_chart2d_panel_at(
        const tc_retained_multi_chart2d* chart, size_t index);
    TCPLOT_API bool tc_retained_multi_chart2d_panel_is_valid(
        const tc_retained_multi_chart2d* chart,
        tc_multi_chart_panel_handle2d panel);
    // The returned chart is borrowed and remains owned by the multi-chart.
    TCPLOT_API tc_retained_chart2d* tc_retained_multi_chart2d_panel_chart(
        tc_retained_multi_chart2d* chart,
        tc_multi_chart_panel_handle2d panel);
