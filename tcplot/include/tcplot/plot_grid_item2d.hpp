...
class TCPLOT_API PlotGridItem2D final
    : public termin::visual::NativeGraphicItem2D {
public:
  PlotGridItem2D(PlotProjection2D projection, std::vector<double> x_ticks = {},
