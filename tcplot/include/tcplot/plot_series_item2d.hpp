...
namespace tcplot {
    ...
    public:
        ...
        bool render(tgfx::RenderContext2& context,
    ...
    class TCPLOT_API PlotLineSeriesItem2D final : public termin::visual::NativeGraphicItem2D {
    public:
        struct State;

        PlotLineSeriesItem2D(PlotProjection2D projection,
                             std::vector<double> x,
                             std::vector<double> y,
        ...
        bool set_data(std::vector<double> x, std::vector<double> y, std::vector<double> scalar = {});
        bool append(std::span<const double> x, std::span<const double> y, std::span<const double> scalar = {});
        ...
        std::optional<PlotNearestPoint2D> nearest(termin::Vec2f pixel, float max_distance_px) const;
    ...
    class TCPLOT_API PlotScatterSeriesItem2D final : public termin::visual::NativeGraphicItem2D {
    public:
        struct State;

        PlotScatterSeriesItem2D(PlotProjection2D projection,
                                std::vector<double> x,
                                std::vector<double> y,
                                PlotScatterSeriesStyle2D style);
    ...
    TCPLOT_API PlotLineSeriesItem2D* resolve_plot_line_series_item2d(termin::visual::TcVisualScene& scene,
                                                                     termin::visual::GraphicItemHandle handle);
    TCPLOT_API const PlotLineSeriesItem2D* resolve_plot_line_series_item2d(const termin::visual::TcVisualScene& scene,
                                                                           termin::visual::GraphicItemHandle handle);
    TCPLOT_API PlotScatterSeriesItem2D* resolve_plot_scatter_series_item2d(termin::visual::TcVisualScene& scene,
                                                                           termin::visual::GraphicItemHandle handle);
