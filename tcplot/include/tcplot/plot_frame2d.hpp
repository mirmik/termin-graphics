...
public:
    ...
    constexpr double x_min() const { return x_min_; }
    constexpr double x_max() const { return x_max_; }
    constexpr double y_min() const { return y_min_; }
    constexpr double y_max() const { return y_max_; }
    constexpr double x_span() const { return x_max_ - x_min_; }
    constexpr double y_span() const { return y_max_ - y_min_; }
...
public:
    ...
    const PlotRect2D& viewport() const { return viewport_; }
    const PlotRect2D& plot_area() const { return plot_area_; }
    const PlotRange2D& range() const { return range_; }
    const PlotRect2D& clip_rect() const { return clip_rect_; }
...
inline constexpr std::array<PlotRenderPhase2D, 5>
    kPlotRenderPhaseOrder2D = {
