...
namespace tcplot {
    ...
    public:
        ...
        int add_line(int panel_idx, SeriesData2DView series, LinePlotOptions options = {});
        ...
        int add_scatter(int panel_idx, SeriesData2DView series, ScatterPlotOptions options = {});

        // Append points to an existing line series. Autoscroll + per-panel
        // Y-autoscale both react to the new data — see set_autoscroll.
        void append_to_line(int panel_idx, int series_idx, const double* x, const double* y, size_t n);
