...
Если доступна проектная доска задач (скилл kanboard-taskboard), фиксируй найденные баги, регрессы, неоконченные миграции и крупные технические хвосты в тикеты. Перед началом нетривиальной работы полезно сверяться с доской, чтобы не плодить дубли и не терять уже зафиксированный контекст. Доска задач не заменяет локальную проверку кода и тесты, но должна отражать актуальное состояние известных проблем.
