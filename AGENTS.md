...
## О субагентах-консультантах
Если вопрос нетривиальный, связанный с возможными регрессиями, сложным межмодульным взаимодействием, и прочими вещами вводящими в замешательство, можно заюзать навык better-call-sol для консультации с более мощной моделью (разумеется, если тебя самого не зовут Sol, а то чего с самим собой консультироваться)
