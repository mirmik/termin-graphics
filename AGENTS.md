...
Если вопрос нетривиальный, связанный с возможными регрессиями, сложным межмодульным взаимодействием, и прочими вещами вводящими в замешательство, можно заюзать навык better-call-sol для консультации с более мощной моделью (разумеется, если тебе доступны субагенты и если тебя самого не зовут Sol)
