...
namespace termin {
    ...
    public:
        ...
        SDLBackendWindow(SDLWindowSystem& window_system,
        ...
        void set_should_close(bool v) override {
            should_close_ = v;
        }
    ...
    public:
        ...
        BackendWindowPtr create_window(tgfx::GraphicsHost& graphics, const WindowConfig& config) override;
