...
namespace termin {
    ...
    public:
        ...
        virtual BackendWindowPtr create_window(tgfx::GraphicsHost& graphics, const WindowConfig& config) = 0;
    ...
    public:
        WindowedGraphicsSession(BackendWindowSystemPtr windows, std::unique_ptr<tgfx::GraphicsHost> graphics);
    ...
    TERMIN_WINDOW_API std::unique_ptr<WindowedGraphicsSession> create_native_windowed_graphics();
