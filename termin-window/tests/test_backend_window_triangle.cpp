...
int main() {
    try {
        ...
        printf("TERMIN_TEST_PRESENTATION_MODE=%s\n",
        ...
        termin::WindowConfig window_config{"BackendWindow triangle smoke", 800, 600, presentation_mode};
        ...
        printf("APPLIED_PRESENTATION_MODE=%s\n",
...
void main() {
    fragColor = vec4(vColor, 1.0);
        ...
        tgfx::ShaderDesc vsd;
        vsd.stage = tgfx::ShaderStage::Vertex;
        vsd.source = vs_src;
        tgfx::ShaderDesc fsd;
        fsd.stage = tgfx::ShaderStage::Fragment;
        fsd.source = fs_src;
        ...
        vbd.usage = tgfx::BufferUsage::Vertex;
        vbd.cpu_visible = true;
        ...
        ibd.usage = tgfx::BufferUsage::Index;
        ibd.cpu_visible = true;
