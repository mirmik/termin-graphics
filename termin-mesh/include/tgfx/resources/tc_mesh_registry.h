...
TGFX_API void tc_mesh_registry_add_destroy_hook(tc_mesh_destroy_hook_fn cb, void* user_data);
TGFX_API void tc_mesh_registry_remove_destroy_hook(tc_mesh_destroy_hook_fn cb, void* user_data);
...
TGFX_API bool tc_mesh_set_data(tc_mesh* mesh,
                               const void* vertices,
                               size_t vertex_count,
                               const tc_vertex_layout* layout,
