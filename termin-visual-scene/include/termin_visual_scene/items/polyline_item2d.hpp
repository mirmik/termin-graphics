...
namespace termin::visual {
    ...
    class TERMIN_VISUAL_SCENE_API PolylineItem2D final : public NativeGraphicItem2D {
    public:
        PolylineItem2D();
        PolylineItem2D(std::vector<termin::Vec2f> points, tgfx::StrokePaint stroke, bool closed = false);

        void set(std::vector<termin::Vec2f> points, tgfx::StrokePaint stroke, bool closed);
