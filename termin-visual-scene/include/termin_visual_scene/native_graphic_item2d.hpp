...
namespace termin::visual {
    ...
    class TERMIN_VISUAL_SCENE_API NativeGraphicItem2D : public GraphicItem2D {
    public:
        ...
        virtual bool hit_test(termin::Vec2f point, float tolerance) const = 0;
    ...
    private:
        ...
        static const NativeGraphicItem2D* from_c(const tc_graphic_item* item);
