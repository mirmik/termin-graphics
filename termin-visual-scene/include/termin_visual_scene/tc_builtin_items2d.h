...
TERMIN_VISUAL_SCENE_API tc_graphic_item_handle tc_visual_group_item2d_create(
    tc_visual_scene_handle scene, tc_graphic_item_handle parent);

TERMIN_VISUAL_SCENE_API tc_graphic_item_handle tc_visual_rect_item2d_create(
    tc_visual_scene_handle scene, tc_graphic_item_handle parent, tc_rect2f rect,
    tc_visual_fill_paint2d fill, const tc_visual_stroke_paint2d *stroke);
TERMIN_VISUAL_SCENE_API bool tc_visual_rect_item2d_set(
    tc_visual_scene_handle scene, tc_graphic_item_handle item, tc_rect2f rect,
    tc_visual_fill_paint2d fill, const tc_visual_stroke_paint2d *stroke);

TERMIN_VISUAL_SCENE_API tc_graphic_item_handle tc_visual_path_item2d_create(
    tc_visual_scene_handle scene, tc_graphic_item_handle parent,
    tc_visual_path2d_view path, const tc_visual_fill_paint2d *fill,
    const tc_visual_stroke_paint2d *stroke);
TERMIN_VISUAL_SCENE_API bool tc_visual_path_item2d_set(
    tc_visual_scene_handle scene, tc_graphic_item_handle item,
    tc_visual_path2d_view path, const tc_visual_fill_paint2d *fill,
    const tc_visual_stroke_paint2d *stroke);

TERMIN_VISUAL_SCENE_API tc_graphic_item_handle tc_visual_text_item2d_create(
    tc_visual_scene_handle scene, tc_graphic_item_handle parent,
    const tc_visual_text_desc2d *desc);
TERMIN_VISUAL_SCENE_API bool
tc_visual_text_item2d_set(tc_visual_scene_handle scene,
                          tc_graphic_item_handle item,
                          const tc_visual_text_desc2d *desc);

TERMIN_VISUAL_SCENE_API tc_graphic_item_handle tc_visual_image_item2d_create(
    tc_visual_scene_handle scene, tc_graphic_item_handle parent,
    const tc_visual_image_desc2d *desc);
TERMIN_VISUAL_SCENE_API bool
tc_visual_image_item2d_set(tc_visual_scene_handle scene,
                           tc_graphic_item_handle item,
                           const tc_visual_image_desc2d *desc);

TERMIN_VISUAL_SCENE_API tc_graphic_item_handle
tc_visual_hit_region_item2d_create(tc_visual_scene_handle scene,
                                   tc_graphic_item_handle parent,
                                   tc_visual_path2d_view path,
                                   tc_visual_fill_rule2d rule);
TERMIN_VISUAL_SCENE_API bool tc_visual_hit_region_item2d_set(
    tc_visual_scene_handle scene, tc_graphic_item_handle item,
