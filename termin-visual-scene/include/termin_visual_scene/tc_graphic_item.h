...
static inline bool tc_graphic_item_handle_is_invalid(
...
TERMIN_VISUAL_SCENE_API const char* tc_graphic_item_type_name(
    const tc_graphic_item* item);
TERMIN_VISUAL_SCENE_API void tc_graphic_item_set_declared_type_name(
    tc_graphic_item* item,
    const char* type_name);

TERMIN_VISUAL_SCENE_API bool tc_graphic_item_append_child(
    tc_graphic_item* parent,
    tc_graphic_item* child);
TERMIN_VISUAL_SCENE_API bool tc_graphic_item_insert_child(
    tc_graphic_item* parent,
    size_t index,
    tc_graphic_item* child);
TERMIN_VISUAL_SCENE_API bool tc_graphic_item_remove_child(
    tc_graphic_item* parent,
    tc_graphic_item* child);
TERMIN_VISUAL_SCENE_API bool tc_graphic_item_detach(
    tc_graphic_item* item);
TERMIN_VISUAL_SCENE_API tc_graphic_item* tc_graphic_item_parent(
    tc_graphic_item* item);
TERMIN_VISUAL_SCENE_API const tc_graphic_item*
tc_graphic_item_parent_const(const tc_graphic_item* item);
TERMIN_VISUAL_SCENE_API size_t tc_graphic_item_child_count(
    const tc_graphic_item* item);
TERMIN_VISUAL_SCENE_API tc_graphic_item* tc_graphic_item_child_at(
    tc_graphic_item* item,
    size_t index);
TERMIN_VISUAL_SCENE_API const tc_graphic_item*
tc_graphic_item_child_at_const(
    const tc_graphic_item* item,
    size_t index);
