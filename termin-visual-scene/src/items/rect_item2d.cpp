...
bool RectItem2D::paint(
    GraphicItemPaintContext2D& context) const
{
    return stroke_
        ? context.rounded_rect(
              rect_, 0.0f, fill_, stroke_)
        : context.rect(rect_, fill_);
}
