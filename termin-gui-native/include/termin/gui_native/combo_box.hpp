...
namespace termin::gui_native {
    ...
    public:
        ...
        Signal<ComboBox&, int, const std::string&>& changed() {
            return changed_;
        }
        const Signal<ComboBox&, int, const std::string&>& changed() const {
            return changed_;
        }
    ...
    private:
        ...
        bool show_popup(tc_ui_document_handle document);
        void hide_popup(tc_ui_document_handle document);
