...
namespace termin::gui_native {
    ...
    public:
        ...
        const tc_widget* c_widget() const {
            return &_widget;
        }
        ...
        tc_ui_document_handle document() {
            return _widget.document;
        }
        tc_ui_document_handle document() const {
            return _widget.document;
        }
        tc_widget_handle handle() const {
            return _widget.handle;
        }
        const char* stable_id() const {
            return tc_widget_stable_id(&_widget);
        }
        const char* name() const {
            return tc_widget_name(&_widget);
        }
        const char* debug_name() const {
            return tc_widget_debug_name(&_widget);
        }
        ...
        void set_focusable(bool focusable) {
            tc_widget_set_focusable(&_widget, focusable);
        }
        bool focusable() const {
            return tc_widget_is_focusable(&_widget);
        }
        void set_visible(bool visible) {
            tc_widget_set_visible(&_widget, visible);
        }
        bool visible() const {
            return tc_widget_is_visible(&_widget);
        }
        void set_enabled(bool enabled) {
            tc_widget_set_enabled(&_widget, enabled);
        }
        bool enabled() const {
            return tc_widget_is_enabled(&_widget);
        }
        void set_tree_participating(bool participating) {
            tc_widget_set_tree_participating(&_widget, participating);
        }
        bool tree_participating() const {
            return tc_widget_is_tree_participating(&_widget);
        }
        void set_mouse_transparent(bool mouse_transparent) {
            tc_widget_set_mouse_transparent(&_widget, mouse_transparent);
        }
        bool mouse_transparent() const {
            return tc_widget_is_mouse_transparent(&_widget);
        }
        ...
        tc_ui_cursor_intent cursor_intent() const {
            return tc_widget_cursor_intent(&_widget);
        }
        tc_widget* parent_widget() {
            return tc_widget_parent(&_widget);
        }
        const tc_widget* parent_widget() const {
            return tc_widget_parent_const(&_widget);
        }
        size_t child_count() const {
            return tc_widget_child_count(&_widget);
        }
        tc_widget* child_at(size_t index) {
            return tc_widget_child_at(&_widget, index);
        }
        const tc_widget* child_at(size_t index) const {
            return tc_widget_child_at_const(&_widget, index);
        }
        ...
        bool append_child(Widget& child) {
            return tc_widget_append_child(&_widget, child.c_widget());
        }
        ...
        bool remove_child(Widget& child) {
            return tc_widget_remove_child(&_widget, child.c_widget());
        }
        bool detach() {
        ...
        void clear_dirty(uint32_t dirty_flags) {
            tc_widget_clear_dirty(&_widget, dirty_flags);
        }
        uint32_t dirty_flags() const {
            return tc_widget_dirty_flags(&_widget);
        }
        bool has_dirty_flags(uint32_t dirty_flags) const {
            return tc_widget_has_dirty_flags(&_widget, dirty_flags);
        }
        void set_style_role(tc_ui_style_role role) {
            tc_widget_set_style_role(&_widget, role);
        }
        tc_ui_style_role style_role() const {
            return tc_widget_style_role(&_widget);
        }
        ...
        void clear_style_override() {
            tc_widget_clear_style_override(&_widget);
        }
        tc_ui_style_override style_override() const {
            return tc_widget_style_override(&_widget);
        }
