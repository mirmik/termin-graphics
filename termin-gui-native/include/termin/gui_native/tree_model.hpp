...
namespace termin::gui_native {
    ...
    public:
        ...
        Signal<TreeModel&, const TreeChange&>& changed() {
            return changed_;
        }
    ...
    public:
        ...
        bool reconcile(const TreeTableModel& model);
        Signal<TreeExpansionModel&, TreeNodeId, bool>& changed() {
            return changed_;
        }
