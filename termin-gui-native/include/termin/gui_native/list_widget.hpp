...
namespace termin::gui_native {
    ...
    public:
        ...
        ~ListWidget() override;
        const std::shared_ptr<CollectionModel>& model() const {
            return model_;
        }
        ...
        Signal<ListWidget&, const std::vector<size_t>&>& selection_changed() {
            return selection_changed_;
        }
        Signal<ListWidget&, size_t, const CollectionItem&>& activated() {
            return activated_;
        }
