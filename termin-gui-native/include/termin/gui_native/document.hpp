...
class Document {
  private:
    ...
    size_t _active_application_hosts = 0;

    void attach_application_host();
    void detach_application_host();
  ...
  public:
    ...
    size_t active_application_host_count() const { return _active_application_hosts; }
    size_t active_window_host_count() const { return active_application_host_count(); }
    ...
    void set_clipboard(tc_ui_clipboard_get_text_fn get_text, tc_ui_clipboard_set_text_fn set_text,
                       void* user_data) {
    ...
    bool measure_text(const char* text_utf8, size_t text_byte_length, float font_size,
        ...
        return tc_ui_document_measure_text(_document, text_utf8, text_byte_length, font_size,
                                           &out_metrics);
    }
