...
namespace termin::gui_native {
    ...
    public:
        ...
        void set_first(const Widget& widget) {
            set_first(widget.handle());
        }
        void set_second(tc_widget_handle handle);
        void set_second(const Widget& widget) {
            set_second(widget.handle());
        }
        ...
        tc_widget_handle first() const {
            return child_handle_at(0);
        }
        tc_widget_handle second() const {
            return child_handle_at(1);
        }
        float split_fraction() const {
            return split_fraction_;
        }
        float divider_thickness() const {
            return divider_thickness_;
        }
