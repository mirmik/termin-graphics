...
enum class CrossAxisAlignment { Auto, Stretch, Start, Center, End };
struct LayoutItem { tc_widget_handle handle {}; LayoutPolicy policy = LayoutPolicy::Stretch; float fixed_extent = 0.0f; float flex = 1.0f; float grow = 1.0f; float shrink = 1.0f; float min_extent = 0.0f; float max_extent = 0.0f; CrossAxisAlignment align_self = CrossAxisAlignment::Auto; };
