...
namespace termin::gui_native {
    ...
    public:
        ...
        bool add_child(tc_widget_handle handle, OverlayAnchor anchor = OverlayAnchor::Fill, tc_ui_point offset = {});
        bool remove_child(tc_widget_handle handle);
        bool set_placement(tc_widget_handle handle, OverlayAnchor anchor, tc_ui_point offset = {});
