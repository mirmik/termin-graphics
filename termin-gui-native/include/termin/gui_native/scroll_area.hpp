...
public:
    ...
    bool horizontal_scroll_enabled() const { return horizontal_scroll_enabled_; }
    bool vertical_scroll_enabled() const { return vertical_scroll_enabled_; }
    ...
    Signal<ScrollArea&, float, float>& changed() { return changed_; }
    const Signal<ScrollArea&, float, float>& changed() const { return changed_; }
