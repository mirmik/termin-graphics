...
namespace termin::gui_native {
    ...
    public:
        explicit SceneView(termin::visual::TcVisualScene scene = {});
        ...
        bool set_widget_portal(termin::visual::GraphicItemHandle item, tc_widget_handle widget);
        bool clear_widget_portal(termin::visual::GraphicItemHandle item);
