...
namespace termin::gui_native {
    ...
    private:
        ...
        Signal<TreeWidget&, TreeNodeId, int, const CollectionItem&> toggle_activated_;
    ...
    public:
        explicit TreeWidget(std::shared_ptr<TreeModel> model = {}, std::shared_ptr<TreeExpansionModel> expansion = {});
        ~TreeWidget() override;

        const std::shared_ptr<TreeModel>& model() const {
            return model_;
        }
        ...
        TreeNodeId selected_node() const {
            return selected_;
        }
        ...
        bool expanded(TreeNodeId node) const {
        ...
        Signal<TreeWidget&, TreeNodeId, int, const CollectionItem&>& toggle_activated() {
        ...
        Signal<TreeWidget&, TreeNodeId, TreeNodeId, TreeDropPosition>& drop_requested() {
    ...
    private:
        ...
        int row_toggle_at(const TreeVisibleRow& row, const CollectionItem& item, float x) const;
