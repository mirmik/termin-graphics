...
namespace termin::gui_native {
    ...
    private:
        ...
        Signal<TreeTableWidget&, TreeTableNodeId, const TreeTableRowData&> activated_;
        Signal<TreeTableWidget&, size_t, const TableColumn&> header_clicked_;
        Signal<TreeTableWidget&, size_t, float> column_resized_;
        Signal<TreeTableWidget&, TreeTableNodeId, float, float> context_menu_requested_;
    ...
    public:
        ...
        const std::shared_ptr<TreeTableModel>& model() const {
            return model_;
        }
        ...
        TreeTableNodeId selected_node() const {
            return selected_;
        }
        ...
        Signal<TreeTableWidget&, TreeTableNodeId, const TreeTableRowData&>& activated() {
            return activated_;
        }
        ...
        Signal<TreeTableWidget&, TreeTableNodeId, float, float>& context_menu_requested() {
