...
namespace termin::gui_native {
    ...
    public:
        ...
        TcDocument document() const {
            return TcDocument(document_);
        }
        const UiScriptDescription& description() const {
            return description_;
        }
        const MaterializedWidget& root() const {
            return root_;
        }
    ...
    public:
        ...
        LoadedUiScript load(const std::string& path, TcDocument document = {}) const;
        LoadedUiScript load_string(const std::string& source,
                                   TcDocument document = {},
                                   const std::string& source_name = "<string>") const;
        LoadedUiScript materialize(const UiScriptDescription& description, TcDocument document = {}) const;
        LoadedUiScript
        reload(LoadedUiScript& loaded, const std::string& source, const std::string& source_name = "<reload>") const;
        LoadedUiScript reload(LoadedUiScript& loaded, const UiScriptDescription& description) const;
    };
