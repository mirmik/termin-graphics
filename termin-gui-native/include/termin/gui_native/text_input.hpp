...
namespace termin::gui_native {
    ...
    public:
        ...
        Signal<TextInput&, const std::string&>& changed() {
            return changed_;
        }
        const Signal<TextInput&, const std::string&>& changed() const {
            return changed_;
        }
        Signal<TextInput&, const std::string&>& submitted() {
            return submitted_;
        }
        const Signal<TextInput&, const std::string&>& submitted() const {
            return submitted_;
        }
