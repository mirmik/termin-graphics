...
namespace termin::gui_native {
    ...
    public:
        ...
        const std::vector<DialogAction>& actions() const {
            return actions_;
        }
        void set_actions(std::vector<DialogAction> actions);
        bool dismiss_on_escape() const {
        ...
        tc_widget_handle content_handle() const {
        ...
        const DialogResult* result() const {
            return has_result_ ? &result_ : nullptr;
        }
        const std::vector<tc_widget_handle>& button_handles() const {
            return button_handles_;
        }

        Signal<Dialog&, const DialogResult&>& finished() {
            return finished_;
        }
