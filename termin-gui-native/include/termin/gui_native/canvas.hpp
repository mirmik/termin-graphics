...
namespace termin::gui_native {
    ...
    public:
        ...
        uint32_t overlay_texture_id() const {
            return overlay_texture_id_;
        }
        tc_ui_size image_size() const {
            return image_size_;
        }
        tc_ui_texture_sampling texture_sampling() const {
            return texture_sampling_;
        }
        ...
        Signal<Canvas&, float>& zoom_changed() {
            return zoom_changed_;
        }
        Signal<Canvas&, tc_ui_point, const tc_ui_pointer_event&>& pointer_input() {
