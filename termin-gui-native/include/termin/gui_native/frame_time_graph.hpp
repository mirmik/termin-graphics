...
namespace termin::gui_native {
    ...
    public:
        ...
        const std::shared_ptr<FrameTimeModel>& model() const {
            return model_;
        }
        void set_model(std::shared_ptr<FrameTimeModel> model);
        float target_frame_ms() const {
            return target_frame_ms_;
        }
        float warning_frame_ms() const {
            return warning_frame_ms_;
        }
