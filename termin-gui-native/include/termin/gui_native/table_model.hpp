...
namespace termin::gui_native {
    ...
    public:
        ...
        Signal<TableModel&, const TableChange&>& changed() {
            return changed_;
        }
    ...
    enum class TableColumnChangeKind {
        Reset,
        Insert,
        Update,
        Erase
    ...
    public:
        ...
        Signal<TableColumnModel&, const TableColumnChange&>& changed() {
            return changed_;
        }
