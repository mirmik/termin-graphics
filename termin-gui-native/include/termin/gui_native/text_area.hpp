...
namespace termin::gui_native {
    ...
    public:
        ...
        Signal<TextArea&, const std::string&>& changed() {
            return changed_;
        }
        const Signal<TextArea&, const std::string&>& changed() const {
            return changed_;
        }
    ...
    private:
        ...
        bool
        measure_range(tc_ui_document_handle document, size_t start, size_t end, float font_size, float& width) const;
