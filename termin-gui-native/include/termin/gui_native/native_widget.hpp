...
public:
    ...
    virtual void overlay_dismissed(tc_ui_document* document, tc_ui_overlay_dismiss_reason reason);
    virtual void on_destroy(tc_ui_document* document);
private:
    static tc_ui_size dispatch_measure(tc_widget* widget, tc_ui_document* document, tc_ui_constraints constraints);
    ...
    static tc_ui_event_result dispatch_pointer_event(tc_widget* widget, tc_ui_document* document, const tc_ui_pointer_event* event);
    static tc_widget_handle dispatch_hit_test(tc_widget* widget, tc_ui_document* document, float x, float y);
    static tc_ui_event_result dispatch_key_event(tc_widget* widget, tc_ui_document* document, const tc_ui_key_event* event);
    static tc_ui_event_result dispatch_text_event(tc_widget* widget, tc_ui_document* document, const tc_ui_text_event* event);
