...
namespace termin::gui_native {
    ...
    public:
        ...
        tc_ui_rect bounds() const {
            return tc_widget_bounds(c_widget());
        }
        void set_min_size(tc_ui_size size) {
            tc_widget_set_min_size(c_widget(), size);
        }
        tc_ui_size min_size() const {
            return tc_widget_min_size(c_widget());
        }
        void set_preferred_size(tc_ui_size size) {
            tc_widget_set_preferred_size(c_widget(), size);
        }
        tc_ui_size preferred_size() const {
            return tc_widget_preferred_size(c_widget());
        }
        void set_max_size(tc_ui_size size) {
            tc_widget_set_max_size(c_widget(), size);
        }
        tc_ui_size max_size() const {
            return tc_widget_max_size(c_widget());
        }
        ...
        virtual void descendant_focused(tc_ui_document_handle document, tc_widget_handle descendant);
    ...
    private:
        static tc_ui_size
        dispatch_measure(tc_widget* widget, tc_ui_document_handle document, tc_ui_constraints constraints);
        ...
        dispatch_pointer_event(tc_widget* widget, tc_ui_document_handle document, const tc_ui_pointer_event* event);
        static tc_widget_handle dispatch_hit_test(tc_widget* widget, tc_ui_document_handle document, float x, float y);
        static tc_ui_event_result
        dispatch_key_event(tc_widget* widget, tc_ui_document_handle document, const tc_ui_key_event* event);
        static tc_ui_event_result
        dispatch_text_event(tc_widget* widget, tc_ui_document_handle document, const tc_ui_text_event* event);
        static void dispatch_focus_event(tc_widget* widget, tc_ui_document_handle document, bool focused);
        static void
        dispatch_descendant_focused(tc_widget* widget, tc_ui_document_handle document, tc_widget_handle descendant);
        static void dispatch_overlay_dismissed(tc_widget* widget,
