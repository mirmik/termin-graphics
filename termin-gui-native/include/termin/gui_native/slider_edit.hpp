...
namespace termin::gui_native {
    ...
    public:
        ...
        tc_widget_handle slider_handle() const {
            return slider_handle_;
        }
        tc_widget_handle spin_box_handle() const {
            return spin_box_handle_;
        }
        Signal<SliderEdit&, float>& changed() {
            return changed_;
        }
        const Signal<SliderEdit&, float>& changed() const {
            return changed_;
        }
