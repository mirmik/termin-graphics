...
namespace termin::gui_native {
    ...
    public:
        ...
        void render(tgfx::RenderContext2& context,
    ...
    private:
        static bool measure_text(void* user_data,
                                 const char* text_utf8,
                                 size_t text_byte_length,
                                 float font_size,
                                 tc_ui_text_metrics* out_metrics);

        static void destroy_picker_surface_texture(tgfx::IRenderDevice* device, ColorPickerSurfaceTexture& surface);
        static void destroy_picker_textures(tgfx::IRenderDevice* device, ColorPickerTextures& textures);
