...
void bind_gui_native_control_views(nb::module_& m) {
    nb::class_<OverlayLayoutRef>(m, "OverlayLayout")
        .def_prop_ro("widget", [](const OverlayLayoutRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const OverlayLayoutRef& self) { return WidgetHandle{self.widget.handle}; })
        .def(
            "add_child",
            [](const OverlayLayoutRef& self,
               const WidgetRef& child,
               termin::gui_native::OverlayAnchor anchor,
               tc_ui_point offset) { return self.get().add_child(child.handle, anchor, offset); },
            nb::arg("child"),
            nb::arg("anchor") = termin::gui_native::OverlayAnchor::Fill,
            nb::arg("offset") = tc_ui_point{})
        .def(
            "remove_child",
            [](const OverlayLayoutRef& self, const WidgetRef& child) { return self.get().remove_child(child.handle); },
            nb::arg("child"))
        .def(
            "set_placement",
            [](const OverlayLayoutRef& self,
               const WidgetRef& child,
               termin::gui_native::OverlayAnchor anchor,
               tc_ui_point offset) { return self.get().set_placement(child.handle, anchor, offset); },
            nb::arg("child"),
            nb::arg("anchor"),
            nb::arg("offset") = tc_ui_point{});
    ...
    nb::class_<ComboBoxRef>(m, "ComboBox")
            ...
            [](const ComboBoxRef& self, nb::object callback) {
                ...
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::ComboBox&, int index, const std::string& text) {
                        try {
        ...
        .def(
            "disconnect_changed",
            [](const ComboBoxRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));
    ...
    nb::class_<IconButtonRef>(m, "IconButton")
        ...
        .def(
            "set_icon",
            [](const IconButtonRef& self, const std::string& icon) { self.get().set_icon(icon); },
            nb::arg("icon"))
        .def(
            "set_texture",
            [](const IconButtonRef& self, tgfx::TextureHandle texture) { self.get().set_texture(texture.id); },
            nb::arg("texture"))
        .def_prop_rw(
            "tooltip",
        ...
        .def(
            ...
            [](const IconButtonRef& self, termin::SrgbColor color) {
        ...
        .def(
            "set_corner_radius",
            [](const IconButtonRef& self, float radius) { self.get().set_corner_radius(radius); },
            nb::arg("radius"))
        .def(
            "set_font_size",
            [](const IconButtonRef& self, float size) { self.get().set_font_size(size); },
            nb::arg("size"))
        .def(
            "connect_clicked",
            [](const IconButtonRef& self, nb::object callback) {
                ...
                return self.get().clicked().connect(
                    [state, callback = std::move(callback)](termin::gui_native::IconButton&) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback();
                        } catch (...) {
        ...
        .def(
            "disconnect_clicked",
            [](const IconButtonRef& self, size_t connection) { return self.get().clicked().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<ProgressBarRef>(m, "ProgressBar")
        .def_prop_ro("widget", [](const ProgressBarRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const ProgressBarRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "value",
            [](const ProgressBarRef& self) { return self.get().value(); },
            [](const ProgressBarRef& self, float value) { self.get().set_value(value); });
    ...
    nb::class_<ImageWidgetRef>(m, "ImageWidget")
        ...
        .def_prop_ro("intrinsic_size", [](const ImageWidgetRef& self) { return self.get().intrinsic_size(); })
        .def(
            "set_texture",
            [](const ImageWidgetRef& self, tgfx::TextureHandle texture, std::optional<tc_ui_size> intrinsic_size) {
                self.get().set_texture(texture.id, intrinsic_size.value_or(tc_ui_size{}));
            },
            nb::arg("texture"),
            nb::arg("intrinsic_size").none() = nb::none())
        ...
        .def_prop_rw(
            ...
            [](const ImageWidgetRef& self, termin::gui_native::ImageFit fit) { self.get().set_fit(fit); })
        .def(
            "set_preserve_aspect",
            [](const ImageWidgetRef& self, bool preserve) { self.get().set_preserve_aspect(preserve); },
            nb::arg("preserve"));
    ...
    nb::class_<CanvasRef>(m, "Canvas")
        ...
        .def_prop_rw(
            ...
            [](const CanvasRef& self, tc_ui_texture_sampling sampling) { self.get().set_texture_sampling(sampling); })
        .def(
            "set_texture",
            [](const CanvasRef& self, tgfx::TextureHandle texture, std::optional<tc_ui_size> image_size) {
                self.get().set_texture(texture.id, image_size.value_or(tc_ui_size{}));
            },
            nb::arg("texture"),
            nb::arg("image_size").none() = nb::none())
        .def("clear_texture", [](const CanvasRef& self) { self.get().clear_texture(); })
        .def(
            "set_overlay_texture",
            [](const CanvasRef& self, tgfx::TextureHandle texture) { self.get().set_overlay_texture(texture.id); },
            nb::arg("texture"))
        .def(
            "set_zoom",
            [](const CanvasRef& self, float zoom, tc_ui_point anchor) { self.get().set_zoom(zoom, anchor); },
            nb::arg("zoom"),
            nb::arg("anchor"))
        .def("fit_in_view", [](const CanvasRef& self) { self.get().fit_in_view(); })
        .def(
            "widget_to_image",
            [](const CanvasRef& self, tc_ui_point point) { return self.get().widget_to_image(point); },
            nb::arg("point"))
        .def(
            "image_to_widget",
            [](const CanvasRef& self, tc_ui_point point) { return self.get().image_to_widget(point); },
            nb::arg("point"))
        .def(
            ...
            [](const CanvasRef& self, nb::object callback) {
                ...
                return self.get().zoom_changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::Canvas&, float zoom) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(zoom);
                        } catch (...) {
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] Canvas zoom callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            ...
            [](const CanvasRef& self, nb::object callback) {
                ...
                return self.get().pointer_input().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::Canvas&, tc_ui_point image_point, const tc_ui_pointer_event& event) {
                        try {
                            nb::gil_scoped_acquire gil;
            ...
            nb::arg("callback"))
        .def(
            "disconnect_zoom_changed",
            [](const CanvasRef& self, size_t connection) { return self.get().zoom_changed().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "disconnect_pointer_input",
            [](const CanvasRef& self, size_t connection) { return self.get().pointer_input().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "set_paint_callback",
            [](const CanvasRef& self, nb::object callback) {
                ...
                auto state = self.widget.state;
                self.get().set_paint_callback(
                    [state, callback = std::move(callback)](termin::gui_native::Canvas&, tc_ui_paint_context* context) {
                        try {
                            nb::gil_scoped_acquire gil;
