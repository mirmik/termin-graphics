...
namespace {
    ...
    template <typename Ref, typename... Bases> void bind_box_layout_api(nb::class_<Ref, Bases...>& cls) {
        cls.def_prop_ro("widget", [](const Ref& self) { return self.widget; })
            .def_prop_ro("handle", [](const Ref& self) { return WidgetHandle{self.widget.handle}; })
            .def(
                "add_child",
                [](const Ref& self, const WidgetRef& child, termin::gui_native::LayoutPolicy policy, float value) {
                    if (self.widget.state != child.state) {
                        throw std::invalid_argument("BoxLayout child belongs to another document");
                    }
            ...
            .def(
                ...
                nb::arg("orientation"))
            .def_prop_ro("orientation", [](const Ref& self) { return self.get().orientation(); })
            .def(
                "set_cross_axis_alignment",
                [](const Ref& self, termin::gui_native::CrossAxisAlignment alignment) {
                    self.get().set_cross_axis_alignment(alignment);
                },
                nb::arg("alignment"))
            .def_prop_ro("cross_axis_alignment", [](const Ref& self) { return self.get().cross_axis_alignment(); })
            .def(
                "set_child_placement",
                [](const Ref& self,
                   const WidgetRef& child,
                   termin::gui_native::LayoutPolicy policy,
                   float basis,
                   float grow,
                   float shrink,
                   float minimum,
                   ...
                   termin::gui_native::CrossAxisAlignment align_self) {
                    ...
                    const bool applied = self.get().set_child_placement(
                        child.handle, policy, basis, grow, shrink, minimum, maximum, align_self);
                    self.widget.throw_pending_exception();
                    return applied;
                },
                nb::arg("child"),
                ...
                nb::arg("minimum") = 0.0f,
                nb::arg("maximum") = 0.0f,
                nb::arg("align_self") = termin::gui_native::CrossAxisAlignment::Auto)
            .def(
                "set_padding",
                [](const Ref& self, termin::gui_native::EdgeInsets padding) { self.get().set_padding(padding); },
                nb::arg("padding"))
            .def(
                "set_layout_padding",
                [](const Ref& self, termin::gui_native::EdgeInsets padding) { self.get().set_padding(padding); },
            ...
            .def(
                "set_spacing",
                [](const Ref& self, float spacing) { self.get().set_spacing(spacing); },
                nb::arg("spacing"))
            .def(
                "set_layout_spacing",
                [](const Ref& self, float spacing) { self.get().set_spacing(spacing); },
            ...
            .def(
                "set_corner_radius",
                [](const Ref& self, float radius) { self.get().set_corner_radius(radius); },
                nb::arg("radius"))
            .def(
            ...
            .def(
                ...
                [](const Ref& self, const WidgetRef& child, float minimum, float maximum) {
                    return self.get().set_child_extent_limits(child.handle, minimum, maximum);
                },
                nb::arg("child"),
                nb::arg("minimum"),
                nb::arg("maximum") = 0.0f);
...
void bind_gui_native_widgets(nb::module_& m) {
    ...
    nb::class_<WidgetRef>(m, "WidgetRef")
        ...
        .def_prop_rw(
            ...
            [](const WidgetRef& self, tc_ui_size value) { tc_widget_set_max_size(self.resolve_checked(), value); })
        .def_prop_rw(
            "layout_spec",
            [](const WidgetRef& self) { return tc_widget_layout_spec(self.resolve_checked()); },
        ...
        .def_prop_rw(
            ...
            [](const WidgetRef& self, bool value) { tc_widget_set_visible(self.resolve_checked(), value); })
        .def_prop_rw(
            "enabled",
            [](const WidgetRef& self) { return tc_widget_is_enabled(self.resolve_checked()); },
            [](const WidgetRef& self, bool value) { tc_widget_set_enabled(self.resolve_checked(), value); })
        .def_prop_rw(
            "mouse_transparent",
            [](const WidgetRef& self) { return tc_widget_is_mouse_transparent(self.resolve_checked()); },
            [](const WidgetRef& self, bool value) { tc_widget_set_mouse_transparent(self.resolve_checked(), value); })
        .def_prop_rw(
            "focusable",
            [](const WidgetRef& self) { return tc_widget_is_focusable(self.resolve_checked()); },
            [](const WidgetRef& self, bool value) { tc_widget_set_focusable(self.resolve_checked(), value); })
        .def_prop_rw(
            "cursor_intent",
            [](const WidgetRef& self) { return tc_widget_cursor_intent(self.resolve_checked()); },
        ...
        .def("style_state",
             [](const WidgetRef& self) {
                 return tc_ui_document_widget_style_state(self.state->document, self.resolve_checked());
             })
        .def(
            "resolve_style",
            [](const WidgetRef& self, uint32_t extra_state) {
                tc_ui_style style{};
                if (!tc_ui_document_resolve_style(self.state->document, self.resolve_checked(), extra_state, &style)) {
        ...
        .def_prop_ro("native_language", [](const WidgetRef& self) { return self.resolve_checked()->native_language; })
        .def_prop_ro("ownership", [](const WidgetRef& self) { return tc_widget_ownership(self.resolve_checked()); })
        .def_prop_ro("dirty_flags", [](const WidgetRef& self) { return tc_widget_dirty_flags(self.resolve_checked()); })
        .def(
            "mark_dirty",
            [](const WidgetRef& self, uint32_t flags) { tc_widget_mark_dirty(self.resolve_checked(), flags); },
            nb::arg("flags"))
        .def(
            "clear_dirty",
            [](const WidgetRef& self, uint32_t flags) { tc_widget_clear_dirty(self.resolve_checked(), flags); },
            nb::arg("flags"))
        .def_prop_ro("parent",
                     [](const WidgetRef& self) -> nb::object {
                         tc_widget* parent = tc_widget_parent(self.resolve_checked());
                         return parent ? nb::cast(WidgetRef{self.state, parent->handle}) : nb::none();
                     })
        ...
        .def(
            ...
            nb::arg("child"))
        .def("detach", [](const WidgetRef& self) { return tc_widget_detach(self.resolve_checked()); })
        .def(
            "measure",
    ...
    nb::class_<GridLayoutRef, WidgetRef>(m, "GridLayout")
        ...
        .def_prop_ro("handle", [](const GridLayoutRef& self) { return WidgetHandle{self.widget.handle}; })
        .def(
            "set_padding",
            [](const GridLayoutRef& self, termin::gui_native::EdgeInsets padding) { self.get().set_padding(padding); },
            nb::arg("padding"))
        .def(
            "set_spacing",
            [](const GridLayoutRef& self, float columns, float rows) { self.get().set_spacing(columns, rows); },
            nb::arg("columns"),
            nb::arg("rows"))
        .def(
            "set_background",
        ...
        .def(
            "add_column",
            [](const GridLayoutRef& self, termin::gui_native::LayoutPolicy policy, float value) {
        ...
        .def(
            ...
            [](const GridLayoutRef& self,
               ...
               size_t column_span) {
                if (self.widget.state != child.state) {
                    throw std::invalid_argument("GridLayout child belongs to another document");
                }
                self.get().add_child(child.handle, row, column, row_span, column_span);
                self.widget.throw_pending_exception();
            },
            nb::arg("child"),
            nb::arg("row"),
            nb::arg("column"),
            nb::arg("row_span") = 1,
            nb::arg("column_span") = 1)
        .def(
            "set_column_extent_limits",
            [](const GridLayoutRef& self, size_t column, float minimum, float maximum) {
                return self.get().set_column_extent_limits(column, minimum, maximum);
            },
            nb::arg("column"),
            nb::arg("minimum"),
            nb::arg("maximum") = 0.0f)
        .def(
            "set_row_extent_limits",
            [](const GridLayoutRef& self, size_t row, float minimum, float maximum) {
                return self.get().set_row_extent_limits(row, minimum, maximum);
            },
            nb::arg("row"),
            nb::arg("minimum"),
            nb::arg("maximum") = 0.0f);
    ...
    nb::class_<WrapLayoutRef, WidgetRef>(m, "WrapLayout")
        .def_prop_ro("widget", [](const WrapLayoutRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const WrapLayoutRef& self) { return WidgetHandle{self.widget.handle}; })
        .def(
            "add_child",
            [](const WrapLayoutRef& self, const WidgetRef& child) {
                if (self.widget.state != child.state) {
                    throw std::invalid_argument("WrapLayout child belongs to another document");
                }
        ...
        .def(
            "set_orientation",
            [](const WrapLayoutRef& self, termin::gui_native::Orientation orientation) {
                self.get().set_orientation(orientation);
            },
            nb::arg("orientation"))
        .def_prop_ro("orientation", [](const WrapLayoutRef& self) { return self.get().orientation(); })
        .def(
            "set_padding",
            [](const WrapLayoutRef& self, termin::gui_native::EdgeInsets padding) { self.get().set_padding(padding); },
            nb::arg("padding"))
        .def(
            "set_spacing",
            [](const WrapLayoutRef& self, float spacing) { self.get().set_spacing(spacing); },
            nb::arg("spacing"))
        .def_prop_ro("spacing", [](const WrapLayoutRef& self) { return self.get().spacing(); })
        .def(
            "set_line_spacing",
            [](const WrapLayoutRef& self, float spacing) { self.get().set_line_spacing(spacing); },
            nb::arg("spacing"))
        .def_prop_ro("line_spacing", [](const WrapLayoutRef& self) { return self.get().line_spacing(); })
        .def(
            "set_line_alignment",
            [](const WrapLayoutRef& self, termin::gui_native::CrossAxisAlignment alignment) {
                self.get().set_line_alignment(alignment);
            },
            nb::arg("alignment"))
        .def_prop_ro("line_alignment", [](const WrapLayoutRef& self) { return self.get().line_alignment(); });
    ...
    nb::class_<PanelRef, WidgetRef>(m, "Panel")
        ...
        .def(
            "set_fill",
            [](const PanelRef& self, tc_ui_color color) { self.get().set_fill({color.r, color.g, color.b, color.a}); },
            nb::arg("color"))
        .def(
            "set_border",
    ...
    nb::class_<LabelRef, WidgetRef>(m, "Label")
        ...
        .def_prop_ro("handle", [](const LabelRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "text",
            [](const LabelRef& self) { return self.get().text(); },
            [](const LabelRef& self, const std::string& text) { self.get().set_text(text); })
        .def(
            "set_color",
            [](const LabelRef& self, tc_ui_color color) { self.get().set_color({color.r, color.g, color.b, color.a}); },
            nb::arg("color"))
        .def(
            "set_font_size",
            [](const LabelRef& self, float font_size) { self.get().set_font_size(font_size); },
            nb::arg("font_size"))
        .def(
            "set_wrap_mode",
            [](const LabelRef& self, termin::gui_native::TextWrapMode mode) { self.get().set_wrap_mode(mode); },
            nb::arg("mode"))
        .def_prop_ro("wrap_mode", [](const LabelRef& self) { return self.get().wrap_mode(); })
        .def(
            "set_overflow",
            [](const LabelRef& self, termin::gui_native::TextOverflow overflow) { self.get().set_overflow(overflow); },
            nb::arg("overflow"))
        .def_prop_ro("overflow", [](const LabelRef& self) { return self.get().overflow(); })
        .def(
            "set_max_lines",
            [](const LabelRef& self, size_t max_lines) { self.get().set_max_lines(max_lines); },
            nb::arg("max_lines"))
        .def_prop_ro("max_lines", [](const LabelRef& self) { return self.get().max_lines(); });

    nb::class_<SliderRef, WidgetRef>(m, "Slider")
        .def_prop_ro("widget", [](const SliderRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const SliderRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "value",
            [](const SliderRef& self) { return self.get().value(); },
            [](const SliderRef& self, float value) {
                self.get().set_value(value);
                self.widget.throw_pending_exception();
            })
        .def_prop_ro("min_value", [](const SliderRef& self) { return self.get().min_value(); })
        .def_prop_ro("max_value", [](const SliderRef& self) { return self.get().max_value(); })
        .def_prop_rw(
            "step",
            [](const SliderRef& self) { return self.get().step(); },
            [](const SliderRef& self, float step) { self.get().set_step(step); })
        .def(
            "set_range",
        ...
        .def(
            ...
            [](const SliderRef& self, nb::object callback) {
                ...
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::Slider&, float value) {
                        try {
                            ...
                            tc_log_error("[termin-gui-native/python] Slider changed callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_changed",
            [](const SliderRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<SeparatorRef, WidgetRef>(m, "Separator")
        .def_prop_ro("widget", [](const SeparatorRef& self) { return self.widget; })
        ...
        .def(
            "set_thickness",
            [](const SeparatorRef& self, float thickness) { self.get().set_thickness(thickness); },
            nb::arg("thickness"));

    nb::class_<SpacerRef, WidgetRef>(m, "Spacer")
        .def_prop_ro("widget", [](const SpacerRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const SpacerRef& self) { return WidgetHandle{self.widget.handle}; });

    nb::class_<SwatchRef, WidgetRef>(m, "Swatch")
        .def_prop_ro("widget", [](const SwatchRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const SwatchRef& self) { return WidgetHandle{self.widget.handle}; });

    nb::class_<TextInputRef>(m, "TextInput")
        .def_prop_ro("widget", [](const TextInputRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const TextInputRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "text",
        ...
        .def_prop_rw(
            ...
            [](const TextInputRef& self, const std::string& value) { self.get().set_placeholder(value); })
        .def_prop_rw(
            "caret",
            [](const TextInputRef& self) { return self.get().caret(); },
            [](const TextInputRef& self, size_t value) { self.get().set_caret(value); })
        .def_prop_ro("has_selection", [](const TextInputRef& self) { return self.get().has_selection(); })
        .def_prop_ro("selection_start", [](const TextInputRef& self) { return self.get().selection_start(); })
        .def_prop_ro("selection_end", [](const TextInputRef& self) { return self.get().selection_end(); })
        .def_prop_ro("selected_text", [](const TextInputRef& self) { return self.get().selected_text(); })
        .def_prop_ro("scroll_x", [](const TextInputRef& self) { return self.get().scroll_x(); })
        .def(
            "select",
            [](const TextInputRef& self, size_t anchor, size_t caret) { self.get().select(anchor, caret); },
            nb::arg("anchor"),
            nb::arg("caret"))
        ...
        .def(
            "connect_changed",
            [](const TextInputRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::TextInput&, const std::string& text) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(text);
                        } catch (...) {
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] TextInput changed callback failed");
                        }
                    });
            },
            nb::arg("callback"))
                ...
                return self.get().submitted().connect(
                    [state, callback = std::move(callback)](termin::gui_native::TextInput&, const std::string& text) {
                        try {
                            ...
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] TextInput submitted callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_changed",
            [](const TextInputRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "disconnect_submitted",
            [](const TextInputRef& self, size_t connection) { return self.get().submitted().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<TextAreaRef>(m, "TextArea")
        .def_prop_ro("widget", [](const TextAreaRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const TextAreaRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "text",
        ...
        .def_prop_rw(
            ...
            [](const TextAreaRef& self, const std::string& value) { self.get().set_placeholder(value); })
        .def_prop_rw(
            "caret",
            [](const TextAreaRef& self) { return self.get().caret(); },
            [](const TextAreaRef& self, size_t value) { self.get().set_caret(value); })
        .def_prop_ro("has_selection", [](const TextAreaRef& self) { return self.get().has_selection(); })
        .def_prop_ro("selection_start", [](const TextAreaRef& self) { return self.get().selection_start(); })
        .def_prop_ro("selection_end", [](const TextAreaRef& self) { return self.get().selection_end(); })
        .def_prop_ro("selected_text", [](const TextAreaRef& self) { return self.get().selected_text(); })
        ...
        .def(
            "select",
            [](const TextAreaRef& self, size_t anchor, size_t caret) { self.get().select(anchor, caret); },
            nb::arg("anchor"),
            nb::arg("caret"))
        ...
        .def(
            "connect_changed",
            [](const TextAreaRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::TextArea&, const std::string& text) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(text);
                        } catch (...) {
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] TextArea changed callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_changed",
            [](const TextAreaRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));
    ...
    nb::class_<SpinBoxRef>(m, "SpinBox")
        ...
        .def(
            "set_range",
            [](const SpinBoxRef& self, float minimum, float maximum) {
                self.get().set_range(minimum, maximum);
                self.widget.throw_pending_exception();
            },
            nb::arg("minimum"),
        ...
        .def(
            "connect_changed",
            [](const SpinBoxRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::SpinBox&, float value) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(value);
                        } catch (...) {
        ...
        .def(
            "disconnect_changed",
            [](const SpinBoxRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));
    ...
    nb::class_<SliderEditRef>(m, "SliderEdit")
        ...
        .def("set_decimals", [](const SliderEditRef& self, int decimals) { self.get().set_decimals(decimals); })
        .def(
            "connect_changed",
            [](const SliderEditRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::SliderEdit&, float value) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(value);
                        } catch (...) {
        ...
        .def(
            "disconnect_changed",
            [](const SliderEditRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<ButtonRef>(m, "Button")
        .def_prop_ro("widget", [](const ButtonRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const ButtonRef& self) { return WidgetHandle{self.widget.handle}; })
        .def(
            "set_text",
        ...
        .def(
            "disconnect_clicked",
            [](const ButtonRef& self, size_t connection) { return self.get().clicked().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<CheckboxRef>(m, "Checkbox")
        .def_prop_ro("widget", [](const CheckboxRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const CheckboxRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "checked",
            [](const CheckboxRef& self) { return self.get().checked(); },
        ...
        .def(
            ...
            [](const CheckboxRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::Checkbox&, bool checked) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(checked);
                        } catch (...) {
        ...
        .def(
            "disconnect_changed",
            [](const CheckboxRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<GroupBoxRef>(m, "GroupBox")
        .def_prop_ro("widget", [](const GroupBoxRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const GroupBoxRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "title",
            [](const GroupBoxRef& self) { return self.get().title(); },
            [](const GroupBoxRef& self, const std::string& title) { self.get().set_title(title); })
        .def_prop_ro("content_handle", [](const GroupBoxRef& self) { return WidgetHandle{self.get().content()}; })
        .def(
            "set_content",
            [](const GroupBoxRef& self, const WidgetRef& content) {
                if (self.widget.state != content.state) {
                    throw std::invalid_argument("GroupBox content belongs to another document");
                }
        ...
        .def(
            "set_padding",
            [](const GroupBoxRef& self, termin::gui_native::EdgeInsets padding) { self.get().set_padding(padding); },
            nb::arg("padding"))
        .def(
            "set_background",
    ...
    nb::class_<ScrollAreaRef>(m, "ScrollArea")
        .def_prop_ro("widget", [](const ScrollAreaRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const ScrollAreaRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_ro("content_handle", [](const ScrollAreaRef& self) { return WidgetHandle{self.get().content()}; })
        .def_prop_rw(
            "scroll_x",
            [](const ScrollAreaRef& self) { return self.get().scroll_x(); },
            [](const ScrollAreaRef& self, float value) { self.get().set_scroll(value, self.get().scroll_y()); })
        .def_prop_rw(
            "scroll_y",
            [](const ScrollAreaRef& self) { return self.get().scroll_y(); },
            [](const ScrollAreaRef& self, float value) { self.get().set_scroll(self.get().scroll_x(), value); })
        .def_prop_ro("content_size", [](const ScrollAreaRef& self) { return self.get().content_size(); })
        .def_prop_ro("horizontal_scroll_enabled",
                     [](const ScrollAreaRef& self) { return self.get().horizontal_scroll_enabled(); })
        .def_prop_ro("vertical_scroll_enabled",
                     [](const ScrollAreaRef& self) { return self.get().vertical_scroll_enabled(); })
        .def_prop_ro("horizontal_scrollbar_policy",
                     [](const ScrollAreaRef& self) { return self.get().horizontal_scrollbar_policy(); })
        .def_prop_ro("vertical_scrollbar_policy",
                     [](const ScrollAreaRef& self) { return self.get().vertical_scrollbar_policy(); })
        .def_prop_ro("horizontal_scrollbar_visible",
                     [](const ScrollAreaRef& self) { return self.get().horizontal_scrollbar_visible(); })
        .def_prop_ro("vertical_scrollbar_visible",
                     [](const ScrollAreaRef& self) { return self.get().vertical_scrollbar_visible(); })
        .def(
            "set_scroll_axes",
        ...
        .def(
            ...
            [](const ScrollAreaRef& self,
               ...
               termin::gui_native::ScrollBarPolicy vertical) { self.get().set_scrollbar_policy(horizontal, vertical); },
            nb::arg("horizontal"),
            nb::arg("vertical"))
        .def(
            "ensure_visible",
            [](const ScrollAreaRef& self, const WidgetRef& descendant) {
                if (self.widget.state != descendant.state) {
                    throw std::invalid_argument("ScrollArea descendant belongs to another document");
                }
        ...
        .def(
            ...
            [](const ScrollAreaRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::ScrollArea&, float x, float y) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(x, y);
                        } catch (...) {
                            ...
                            tc_log_error("[termin-gui-native/python] ScrollArea changed callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_changed",
            [](const ScrollAreaRef& self, size_t connection) { return self.get().changed().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "set_content",
            [](const ScrollAreaRef& self, const WidgetRef& content) {
                if (self.widget.state != content.state) {
                    throw std::invalid_argument("ScrollArea content belongs to another document");
                }
                self.get().set_content(content.handle);
                self.widget.throw_pending_exception();
            },
    ...
    nb::class_<SplitterRef>(m, "Splitter")
        ...
        .def_prop_ro("handle", [](const SplitterRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "split_fraction",
            [](const SplitterRef& self) { return self.get().split_fraction(); },
            [](const SplitterRef& self, float value) { self.get().set_split_fraction(value); })
        .def_prop_ro("divider_thickness", [](const SplitterRef& self) { return self.get().divider_thickness(); })
        .def(
            "set_split_fraction",
            [](const SplitterRef& self, float value) { self.get().set_split_fraction(value); },
            nb::arg("value"))
        .def(
            "set_first",
            [](const SplitterRef& self, const WidgetRef& widget) {
        ...
        .def(
            "set_min_extents",
            [](const SplitterRef& self, float first, float second) { self.get().set_min_extents(first, second); },
            nb::arg("first"),
            nb::arg("second"))
        .def(
            "set_divider_thickness",
            [](const SplitterRef& self, float thickness) { self.get().set_divider_thickness(thickness); },
            nb::arg("thickness"));
