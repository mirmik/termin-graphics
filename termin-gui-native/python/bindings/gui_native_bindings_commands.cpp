...
void bind_gui_native_commands_and_dialogs(nb::module_& m) {
    ...
    nb::class_<termin::gui_native::CommandModel>(m, "CommandModel")
        ...
        .def_prop_ro("commands", [](const termin::gui_native::CommandModel& self) { return self.commands(); })
        ...
        .def(
            "command_at",
            [](const termin::gui_native::CommandModel& self, size_t index) { return self.command_at(index); },
            nb::arg("index"))
        .def(
            "command",
            [](const termin::gui_native::CommandModel& self, termin::gui_native::CommandId command) {
        ...
        .def("insert", &termin::gui_native::CommandModel::insert, nb::arg("index"), nb::arg("command"))
        .def("update", &termin::gui_native::CommandModel::update, nb::arg("command"), nb::arg("data"))
        .def("set_enabled", &termin::gui_native::CommandModel::set_enabled, nb::arg("command"), nb::arg("enabled"))
        .def("set_checked", &termin::gui_native::CommandModel::set_checked, nb::arg("command"), nb::arg("checked"))
    ...
    nb::class_<ToolBarRef>(m, "ToolBar")
        ...
        .def_prop_rw(
            "model",
            [](const ToolBarRef& self) { return self.get().model(); },
        ...
        .def_prop_ro("hovered_tooltip", [](const ToolBarRef& self) { return self.get().hovered_tooltip(); })
        .def_prop_rw(
            "item_height",
            [](const ToolBarRef& self) { return self.get().item_height(); },
        ...
        .def(
            ...
            [](const ToolBarRef& self, nb::object callback) {
                ...
                return self.get().activated().connect(
                    [state, callback = std::move(callback)](termin::gui_native::ToolBar&,
                                                            size_t index,
                        ...
                        try {
                            ...
                            tc_log_error("[termin-gui-native/python] ToolBar activation callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_activated",
            [](const ToolBarRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<TabViewRef>(m, "TabView")
        .def_prop_ro("widget", [](const TabViewRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const TabViewRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_ro("page_count", [](const TabViewRef& self) { return self.get().page_count(); })
        .def_prop_rw(
            "selected_index",
        ...
        .def(
            "add_page",
            [](const TabViewRef& self, const std::string& title, const WidgetRef& page) {
                if (self.widget.state != page.state) {
                    throw std::invalid_argument("TabView page belongs to another document");
                }
        ...
        .def(
            "page_title",
            [](const TabViewRef& self, size_t index) { return self.get().page_title(index); },
            nb::arg("index"))
        .def(
            "page_handle",
            [](const TabViewRef& self, size_t index) { return WidgetHandle{self.get().page_handle(index)}; },
            nb::arg("index"))
        .def(
            ...
            [](const TabViewRef& self, nb::object callback) {
                ...
                return self.get().selection_changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::TabView&, size_t index) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index);
                        } catch (...) {
    ...
    nb::class_<MenuRef>(m, "Menu")
        ...
        .def_prop_rw(
            "model",
            [](const MenuRef& self) { return self.get().model(); },
        ...
        .def_prop_rw(
            "max_visible_height",
            [](const MenuRef& self) { return self.get().max_visible_height(); },
            [](const MenuRef& self, float value) { self.get().set_max_visible_height(value); })
        .def(
            "show",
            [](const MenuRef& self, tc_ui_point position, tc_ui_rect viewport, bool dismiss_on_outside) {
                return self.get().show(self.widget.state->document, position, viewport, dismiss_on_outside);
            },
            nb::arg("position"),
            nb::arg("viewport"),
            nb::arg("dismiss_on_outside") = true)
        .def(
            "dismiss",
            [](const MenuRef& self, tc_ui_overlay_dismiss_reason reason) {
                return self.get().dismiss(self.widget.state->document, reason);
            },
            nb::arg("reason") = TC_UI_OVERLAY_DISMISS_PROGRAMMATIC)
        .def(
            "connect_activated",
            [](const MenuRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().activated().connect(
                    [state, callback = std::move(callback)](termin::gui_native::Menu&,
                                                            size_t index,
                                                            termin::gui_native::CommandId id,
                                                            const termin::gui_native::CommandData& command) {
                        try {
        ...
        .def(
            "disconnect_activated",
            [](const MenuRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<termin::gui_native::MenuBarEntry>(m, "MenuBarEntry")
        .def(nb::init<std::string, std::string, std::shared_ptr<termin::gui_native::CommandModel>>(),
             nb::arg("stable_id"),
             nb::arg("label"),
             nb::arg("menu"))
    ...
    nb::class_<MenuBarRef>(m, "MenuBar")
        ...
        .def_prop_rw(
            "entries",
            [](const MenuBarRef& self) { return self.get().entries(); },
            [](const MenuBarRef& self, std::vector<termin::gui_native::MenuBarEntry> entries) {
        ...
        .def_prop_ro("open_index",
                     [](const MenuBarRef& self) -> int64_t {
                         const size_t index = self.get().open_index();
                         return index == SIZE_MAX ? -1 : static_cast<int64_t>(index);
                     })
        .def(
            "add_menu",
            [](const MenuBarRef& self, termin::gui_native::MenuBarEntry entry) {
        ...
        .def(
            "dispatch_shortcut",
            [](const MenuBarRef& self, int32_t key, int32_t modifiers) {
        ...
        .def(
            "connect_activated",
            [](const MenuBarRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().activated().connect(
                    [state, callback = std::move(callback)](termin::gui_native::MenuBar&,
                                                            size_t menu,
                                                            termin::gui_native::CommandId id,
                                                            const termin::gui_native::CommandData& command) {
                        try {
        ...
        .def(
            "disconnect_activated",
            [](const MenuBarRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<StatusBarRef>(m, "StatusBar")
        .def_prop_ro("widget", [](const StatusBarRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const StatusBarRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "text",
            [](const StatusBarRef& self) { return self.get().text(); },
            [](const StatusBarRef& self, std::string value) { self.get().set_text(std::move(value)); })
        .def_prop_ro("message", [](const StatusBarRef& self) { return self.get().message(); })
        .def_prop_ro("has_message", [](const StatusBarRef& self) { return self.get().has_message(); })
        .def_prop_ro("displayed_text", [](const StatusBarRef& self) { return self.get().displayed_text(); })
        .def(
            "show_message",
            [](const StatusBarRef& self, std::string message) { self.get().show_message(std::move(message)); },
            nb::arg("message"))
    ...
    nb::class_<termin::gui_native::FileDialogFilter>(m, "FileDialogFilter")
        .def(nb::init<std::string, std::vector<std::string>>(), nb::arg("label"), nb::arg("patterns"))
    ...
    nb::class_<termin::gui_native::FileDialogEntry>(m, "FileDialogEntry")
        .def_prop_ro("name", [](const termin::gui_native::FileDialogEntry& self) { return self.name; })
        .def_prop_ro("path", [](const termin::gui_native::FileDialogEntry& self) { return self.path; })
        .def_prop_ro("is_directory", [](const termin::gui_native::FileDialogEntry& self) { return self.is_directory; })
        .def_prop_ro("size", [](const termin::gui_native::FileDialogEntry& self) { return self.size; })
        .def_prop_ro("modified_time",
                     [](const termin::gui_native::FileDialogEntry& self) { return self.modified_time; });

    nb::class_<termin::gui_native::FileDialogConfirmResult>(m, "FileDialogConfirmResult")
        .def_prop_ro("path", [](const termin::gui_native::FileDialogConfirmResult& self) { return self.path; })
        .def_prop_ro("error", [](const termin::gui_native::FileDialogConfirmResult& self) { return self.error; });
    ...
    nb::class_<termin::gui_native::FileDialogModel>(m, "FileDialogModel")
        ...
        .def_prop_ro("current_directory", &termin::gui_native::FileDialogModel::current_directory)
        ...
        .def_prop_ro("selected_filter", &termin::gui_native::FileDialogModel::selected_filter)
        .def_prop_ro("selected_index", &termin::gui_native::FileDialogModel::selected_index)
        .def_prop_rw("file_name",
                     &termin::gui_native::FileDialogModel::file_name,
        ...
        .def_static("parse_filter_string", &termin::gui_native::FileDialogModel::parse_filter_string, nb::arg("text"))
        .def("set_filters", &termin::gui_native::FileDialogModel::set_filters, nb::arg("filters"))
        .def("set_filter", &termin::gui_native::FileDialogModel::set_filter, nb::arg("index"))
        .def(
            "navigate", &termin::gui_native::FileDialogModel::navigate, nb::arg("path"), nb::arg("push_history") = true)
        ...
        .def("create_directory", &termin::gui_native::FileDialogModel::create_directory, nb::arg("name"));

    nb::class_<termin::gui_native::DialogAction>(m, "DialogAction")
        .def(nb::init<std::string, std::string, bool, bool>(),
             nb::arg("stable_id"),
             nb::arg("label"),
             nb::arg("is_default") = false,
             nb::arg("is_cancel") = false)
    ...
    nb::class_<termin::gui_native::DialogResult>(m, "DialogResult")
        .def_prop_ro("action_id", [](const termin::gui_native::DialogResult& self) { return self.action_id; })
        .def_prop_ro("reason", [](const termin::gui_native::DialogResult& self) { return self.reason; });
    ...
    nb::class_<DialogRef>(m, "Dialog")
        ...
        .def_prop_rw(
            "title",
            [](const DialogRef& self) { return self.get().title(); },
            [](const DialogRef& self, std::string title) { self.get().set_title(std::move(title)); })
        .def_prop_rw(
            "actions",
            [](const DialogRef& self) { return self.get().actions(); },
            [](const DialogRef& self, std::vector<termin::gui_native::DialogAction> actions) {
                self.get().set_actions(std::move(actions));
            })
        .def_prop_rw(
            "dismiss_on_escape",
            [](const DialogRef& self) { return self.get().dismiss_on_escape(); },
            [](const DialogRef& self, bool enabled) { self.get().set_dismiss_on_escape(enabled); })
        .def_prop_rw(
            "draggable",
            [](const DialogRef& self) { return self.get().draggable(); },
            [](const DialogRef& self, bool enabled) { self.get().set_draggable(enabled); })
        .def_prop_ro("open", [](const DialogRef& self) { return self.get().open(); })
        .def(
            "set_content",
            [](const DialogRef& self, const WidgetRef& content) {
        ...
        .def(
            "show",
            [](const DialogRef& self, tc_ui_rect viewport) {
                return self.get().show(self.widget.state->document, viewport);
            },
            nb::arg("viewport"))
        .def("close", [](const DialogRef& self) { return self.get().close(self.widget.state->document); })
        .def(
            "activate",
            [](const DialogRef& self, const std::string& action_id) {
                return self.get().activate(action_id, self.widget.state->document);
            },
            nb::arg("action_id"))
        .def(
            "connect_finished",
            [](const DialogRef& self, nb::object callback) {
                auto state = self.widget.state;
        ...
        .def(
            "disconnect_finished",
            [](const DialogRef& self, size_t connection) { return self.get().finished().disconnect(connection); },
            nb::arg("connection"));
    ...
    nb::class_<MessageBoxRef>(m, "MessageBox")
        ...
        .def_prop_ro("handle", [](const MessageBoxRef& self) { return WidgetHandle{self.widget.handle}; })
        ...
        .def_prop_rw(
            ...
            [](const MessageBoxRef& self, bool enabled) { self.get().set_draggable(enabled); })
        .def_prop_ro("open", [](const MessageBoxRef& self) { return self.get().open(); })
        .def(
            "show",
            [](const MessageBoxRef& self, tc_ui_rect viewport) {
                return self.get().show(self.widget.state->document, viewport);
            },
            nb::arg("viewport"))
        .def(
            "connect_finished",
            [](const MessageBoxRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().finished().connect(
                    [state, callback = std::move(callback)](termin::gui_native::Dialog&,
                                                            const termin::gui_native::DialogResult& result) {
        ...
        .def(
            "disconnect_finished",
            [](const MessageBoxRef& self, size_t connection) { return self.get().finished().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<InputDialogRef>(m, "InputDialog")
        .def_prop_ro("widget", [](const InputDialogRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const InputDialogRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_ro("message", [](const InputDialogRef& self) { return self.get().message(); })
        .def_prop_rw(
            "value",
            [](const InputDialogRef& self) { return self.get().value(); },
            [](const InputDialogRef& self, std::string value) { self.get().set_value(std::move(value)); })
        .def_prop_rw(
            "draggable",
            [](const InputDialogRef& self) { return self.get().draggable(); },
            [](const InputDialogRef& self, bool enabled) { self.get().set_draggable(enabled); })
        .def_prop_ro("open", [](const InputDialogRef& self) { return self.get().open(); })
        .def(
            "show",
            [](const InputDialogRef& self, tc_ui_rect viewport) {
                return self.get().show(self.widget.state->document, viewport);
            },
            nb::arg("viewport"))
        .def(
            "connect_value_finished",
            [](const InputDialogRef& self, nb::object callback) {
                auto state = self.widget.state;
    ...
    nb::class_<FileDialogOverlayRef>(m, "FileDialogOverlay")
        ...
        .def_prop_ro("handle", [](const FileDialogOverlayRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "title",
            [](const FileDialogOverlayRef& self) { return self.get().title(); },
            [](const FileDialogOverlayRef& self, std::string title) { self.get().set_title(std::move(title)); })
        .def_prop_ro(
            "model",
            [](const FileDialogOverlayRef& self) -> termin::gui_native::FileDialogModel& { return self.get().model(); },
            nb::rv_policy::reference_internal)
        .def_prop_rw(
            "draggable",
            [](const FileDialogOverlayRef& self) { return self.get().draggable(); },
            [](const FileDialogOverlayRef& self, bool enabled) { self.get().set_draggable(enabled); })
        .def_prop_ro("open", [](const FileDialogOverlayRef& self) { return self.get().open(); })
        .def(
            "set_filters",
            [](const FileDialogOverlayRef& self, std::vector<termin::gui_native::FileDialogFilter> filters) {
                self.get().set_filters(std::move(filters));
            },
            nb::arg("filters"))
        .def(
            "set_initial_directory",
            [](const FileDialogOverlayRef& self, std::string directory) {
                self.get().set_initial_directory(std::move(directory));
            },
            nb::arg("directory"))
        .def(
            "set_file_name",
            [](const FileDialogOverlayRef& self, std::string file_name) {
                self.get().set_file_name(std::move(file_name));
            },
            nb::arg("file_name"))
        .def(
            "show",
            [](const FileDialogOverlayRef& self, tc_ui_rect viewport) {
                return self.get().show(self.widget.state->document, viewport);
            },
            nb::arg("viewport"))
        .def(
            "activate",
            [](const FileDialogOverlayRef& self, const std::string& action_id) {
                return self.get().activate(action_id, self.widget.state->document);
            },
            nb::arg("action_id"))
        .def(
            "connect_path_finished",
            [](const FileDialogOverlayRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().path_finished().connect(
                    [state, callback = std::move(callback)](termin::gui_native::FileDialogOverlay&,
                        ...
                        try {
                            ...
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] FileDialogOverlay callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_path_finished",
    ...
    nb::class_<termin::gui_native::ColorPickerSurface>(m, "ColorPickerSurface")
        .def_prop_ro("width", [](const termin::gui_native::ColorPickerSurface& self) { return self.width; })
        .def_prop_ro("height", [](const termin::gui_native::ColorPickerSurface& self) { return self.height; })
        .def_prop_ro("revision", [](const termin::gui_native::ColorPickerSurface& self) { return self.revision; })
    ...
    nb::class_<termin::gui_native::ColorPickerTextureIds>(m, "ColorPickerTextureIds")
        .def(nb::init<uint32_t, uint32_t, uint32_t>(),
             nb::arg("saturation_value") = 0,
             nb::arg("hue") = 0,
             nb::arg("alpha") = 0)
        .def_rw("saturation_value", &termin::gui_native::ColorPickerTextureIds::saturation_value)
    ...
    nb::class_<termin::gui_native::ColorPickerModel>(m, "ColorPickerModel")
        ...
        .def_prop_rw(
            "value", &termin::gui_native::ColorPickerModel::value, &termin::gui_native::ColorPickerModel::set_value)
        .def_prop_rw(
            "alpha", &termin::gui_native::ColorPickerModel::alpha, &termin::gui_native::ColorPickerModel::set_alpha)
        .def_prop_rw("show_alpha",
                     &termin::gui_native::ColorPickerModel::show_alpha,
                     &termin::gui_native::ColorPickerModel::set_show_alpha)
        .def_prop_ro("revision", &termin::gui_native::ColorPickerModel::revision)
        .def("set_hsv",
             &termin::gui_native::ColorPickerModel::set_hsv,
             nb::arg("hue"),
             nb::arg("saturation"),
             nb::arg("value"));
    ...
    nb::class_<ColorPickerRef>(m, "ColorPicker")
        ...
        .def_prop_ro("handle", [](const ColorPickerRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "model",
            [](const ColorPickerRef& self) { return self.get().model(); },
            [](const ColorPickerRef& self, std::shared_ptr<termin::gui_native::ColorPickerModel> model) {
                self.get().set_model(std::move(model));
            })
        .def_prop_rw(
            "texture_ids",
            [](const ColorPickerRef& self) { return self.get().texture_ids(); },
            [](const ColorPickerRef& self, termin::gui_native::ColorPickerTextureIds ids) {
                self.get().set_texture_ids(ids);
            })
        .def(
            "surface",
            [](const ColorPickerRef& self, termin::gui_native::ColorPickerSurfaceKind kind)
                -> const termin::gui_native::ColorPickerSurface& { return self.get().surface(kind); },
            nb::arg("kind"),
            nb::rv_policy::reference_internal)
        .def(
            "connect_surfaces_invalidated",
            [](const ColorPickerRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().surfaces_invalidated().connect(
                    [state, callback = std::move(callback)](termin::gui_native::ColorPicker&, uint32_t flags) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(flags);
                        } catch (...) {
                            if (state && !state->pending_exception)
                                state->pending_exception = std::current_exception();
                            tc_log_error("[termin-gui-native/python] ColorPicker surface callback failed");
                        }
                    });
            },
            nb::arg("callback"))
        .def(
            "disconnect_surfaces_invalidated",
    ...
    nb::class_<ColorDialogRef>(m, "ColorDialog")
        ...
        .def_prop_ro("handle", [](const ColorDialogRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_ro("model", [](const ColorDialogRef& self) { return self.get().model(); })
        .def_prop_ro("picker",
                     [](const ColorDialogRef& self) -> nb::object {
