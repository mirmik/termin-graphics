...
void bind_gui_native_collection_views(nb::module_& m) {
    ...
    nb::class_<ListWidgetRef>(m, "ListWidget")
        ...
        .def_prop_ro("current_index",
                     [](const ListWidgetRef& self) -> int64_t {
                         ...
                         return index == termin::gui_native::SelectionModel::npos ? -1 : static_cast<int64_t>(index);
                     })
        .def_prop_rw(
            "scroll_y",
            [](const ListWidgetRef& self) { return self.get().scroll_y(); },
            [](const ListWidgetRef& self, float value) { self.get().set_scroll_y(value); })
        .def_prop_ro("content_height", [](const ListWidgetRef& self) { return self.get().content_height(); })
        ...
        .def(
            ...
            [](const ListWidgetRef& self, nb::object callback) {
                ...
                return self.get().context_menu_requested().connect(
                    [state,
                     callback = std::move(callback)](termin::gui_native::ListWidget&, int64_t index, float x, float y) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, x, y);
                        } catch (...) {
            ...
            [](const ListWidgetRef& self, nb::object callback) {
                ...
                return self.get().activated().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::ListWidget&, size_t index, const termin::gui_native::CollectionItem& item) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, item);
                        } catch (...) {
        ...
        .def(
            ...
            nb::arg("connection"))
        .def(
            "disconnect_context_menu_requested",
            [](const ListWidgetRef& self, size_t connection) {
        ...
        .def(
            ...
            [](const ListWidgetRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"));

    nb::class_<FileGridWidgetRef>(m, "FileGridWidget")
        .def_prop_ro("widget", [](const FileGridWidgetRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const FileGridWidgetRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "model",
            [](const FileGridWidgetRef& self) { return self.get().model(); },
            [](const FileGridWidgetRef& self, std::shared_ptr<termin::gui_native::CollectionModel> model) {
                self.get().set_model(std::move(model));
            })
        .def_prop_rw(
            "selection_mode",
        ...
        .def_prop_ro("column_count", [](const FileGridWidgetRef& self) { return self.get().column_count(); })
        .def_prop_ro("row_count", [](const FileGridWidgetRef& self) { return self.get().row_count(); })
        .def_prop_rw(
            "scroll_y",
        ...
        .def_prop_ro("content_height", [](const FileGridWidgetRef& self) { return self.get().content_height(); })
        .def_prop_ro("has_scrollbar", [](const FileGridWidgetRef& self) { return self.get().has_scrollbar(); })
        ...
        .def_prop_rw(
            ...
            [](const FileGridWidgetRef& self, std::string value) { self.get().set_empty_text(std::move(value)); })
        .def(
            "set_tile_size",
            [](const FileGridWidgetRef& self, float width, float height) { self.get().set_tile_size(width, height); },
            nb::arg("width"),
            nb::arg("height"))
        .def(
            "set_tile_spacing",
            [](const FileGridWidgetRef& self, float spacing) { self.get().set_tile_spacing(spacing); },
            nb::arg("spacing"))
        .def(
            "set_padding",
        ...
        .def(
            "set_scrollbar_width",
            [](const FileGridWidgetRef& self, float width) { self.get().set_scrollbar_width(width); },
            nb::arg("width"))
        .def(
            "item_rect",
        ...
        .def(
            "select",
            [](const FileGridWidgetRef& self, size_t index, bool toggle, bool extend, bool additive) {
                const bool changed = self.get().select_index(index, toggle, extend, additive);
                self.widget.throw_pending_exception();
                return changed;
            },
        ...
        .def(
            ...
            [](const FileGridWidgetRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().selection_changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::FileGridWidget&,
                                                            const std::vector<size_t>& selected) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(selected);
        ...
        .def(
            ...
            [](const FileGridWidgetRef& self, nb::object callback) {
                ...
                return self.get().context_menu_requested().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::FileGridWidget&, int64_t index, float x, float y) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, x, y);
                        } catch (...) {
        ...
        .def(
            ...
            [](const FileGridWidgetRef& self, nb::object callback) {
                ...
                return self.get().drag_requested().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::FileGridWidget&, size_t index, float x, float y, int32_t modifiers) {
                        try {
                            nb::gil_scoped_acquire gil;
    ...
    nb::class_<termin::gui_native::TreeNode>(m, "TreeNode")
        ...
        .def_prop_ro("children", [](const termin::gui_native::TreeNode& self) { return self.children; });

    nb::class_<termin::gui_native::TreeVisibleRow>(m, "TreeVisibleRow")
        .def_prop_ro("node", [](const termin::gui_native::TreeVisibleRow& self) { return self.node; })
        .def_prop_ro("depth", [](const termin::gui_native::TreeVisibleRow& self) { return self.depth; });
    ...
    nb::class_<termin::gui_native::TreeModel>(m, "TreeModel")
        ...
        .def_prop_ro("roots", [](const termin::gui_native::TreeModel& self) { return self.roots(); })
        ...
        .def("append_child", &termin::gui_native::TreeModel::append_child, nb::arg("parent"), nb::arg("item"))
        .def("insert_child",
             &termin::gui_native::TreeModel::insert_child,
             nb::arg("parent"),
             nb::arg("index"),
             nb::arg("item"))
        .def("update", &termin::gui_native::TreeModel::update, nb::arg("node"), nb::arg("item"))
        .def("move",
             &termin::gui_native::TreeModel::move,
             nb::arg("node"),
    ...
    nb::class_<termin::gui_native::TreeExpansionModel>(m, "TreeExpansionModel")
        ...
        .def(
            "set_expanded", &termin::gui_native::TreeExpansionModel::set_expanded, nb::arg("node"), nb::arg("expanded"))
        .def("toggle", &termin::gui_native::TreeExpansionModel::toggle, nb::arg("node"))
        .def("clear", &termin::gui_native::TreeExpansionModel::clear)
        .def(
            "reconcile",
            [](termin::gui_native::TreeExpansionModel& self, const termin::gui_native::TreeModel& model) {
    ...
    nb::class_<TreeWidgetRef>(m, "TreeWidget")
        ...
        .def_prop_ro("handle", [](const TreeWidgetRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "model",
            [](const TreeWidgetRef& self) { return self.get().model(); },
        ...
        .def_prop_rw(
            ...
            [](const TreeWidgetRef& self, std::shared_ptr<termin::gui_native::TreeExpansionModel> expansion) {
                self.get().set_expansion_model(std::move(expansion));
            })
        .def_prop_ro("selected_node", [](const TreeWidgetRef& self) { return self.get().selected_node(); })
        .def_prop_rw(
            "draggable",
        ...
        .def_prop_ro("content_height", [](const TreeWidgetRef& self) { return self.get().content_height(); })
        .def_prop_ro("visible_count", [](const TreeWidgetRef& self) { return self.get().visible_count(); })
        .def_prop_ro("visible_range",
        ...
        .def(
            "expanded",
            [](const TreeWidgetRef& self, termin::gui_native::TreeNodeId node) { return self.get().expanded(node); },
            nb::arg("node"))
        .def(
            "ensure_visible",
            [](const TreeWidgetRef& self, termin::gui_native::TreeNodeId node) {
        ...
        .def(
            ...
            [](const TreeWidgetRef& self, nb::object callback) {
                ...
                return self.get().expansion_changed().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::TreeWidget&, termin::gui_native::TreeNodeId node, bool expanded) {
                        try {
                            nb::gil_scoped_acquire gil;
        ...
        .def(
            ...
            [](const TreeWidgetRef& self, nb::object callback) {
                ...
                return self.get().context_menu_requested().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::TreeWidget&, termin::gui_native::TreeNodeId node, float x, float y) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(node, x, y);
                        } catch (...) {
        ...
        .def(
            "disconnect_activated",
            [](const TreeWidgetRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "disconnect_toggle_activated",
            [](const TreeWidgetRef& self, size_t connection) {
    ...
    nb::class_<termin::gui_native::TreeTableRowData>(m, "TreeTableRowData")
        ...
        .def(
            "__init__",
            [](termin::gui_native::TreeTableRowData* self,
               std::string stable_id,
               std::string parent_stable_id,
               std::vector<std::string> cells,
               bool enabled) {
                new (self) termin::gui_native::TreeTableRowData{
                    std::move(stable_id), std::move(parent_stable_id), std::move(cells), enabled};
            },
            nb::arg("stable_id"),
            nb::arg("parent_stable_id"),
            nb::arg("cells"),
            nb::arg("enabled") = true)
        .def_rw("stable_id", &termin::gui_native::TreeTableRowData::stable_id)
        .def_rw("parent_stable_id", &termin::gui_native::TreeTableRowData::parent_stable_id)
    ...
    nb::class_<termin::gui_native::TreeTableNode>(m, "TreeTableNode")
        .def_prop_ro("id", [](const termin::gui_native::TreeTableNode& self) { return self.id; })
        .def_prop_ro("data", [](const termin::gui_native::TreeTableNode& self) { return self.data; })
        .def_prop_ro("parent", [](const termin::gui_native::TreeTableNode& self) { return self.parent; })
        .def_prop_ro("children", [](const termin::gui_native::TreeTableNode& self) { return self.children; });
    ...
    nb::class_<termin::gui_native::TreeTableModel>(m, "TreeTableModel")
        ...
        .def_prop_ro("roots", [](const termin::gui_native::TreeTableModel& self) { return self.roots(); })
        .def("contains", &termin::gui_native::TreeTableModel::contains, nb::arg("node"))
        .def("find", &termin::gui_native::TreeTableModel::find, nb::arg("stable_id"))
        .def(
            "node",
            [](const termin::gui_native::TreeTableModel& self, termin::gui_native::TreeTableNodeId node) {
                return self.node(node);
            },
            nb::arg("node"))
        .def(
            "children",
            [](const termin::gui_native::TreeTableModel& self, termin::gui_native::TreeTableNodeId parent) {
                return self.children(parent);
            },
            nb::arg("parent") = termin::gui_native::kInvalidTreeTableNodeId)
        .def("set_rows", &termin::gui_native::TreeTableModel::set_rows, nb::arg("rows"))
    ...
    nb::class_<termin::gui_native::TableRowData>(m, "TableRowData")
        ...
        .def(
            "__init__",
            [](termin::gui_native::TableRowData* self,
               std::string stable_id,
               std::vector<std::string> cells,
               bool enabled) {
                new (self) termin::gui_native::TableRowData{std::move(stable_id), std::move(cells), enabled};
            },
            nb::arg("stable_id"),
            nb::arg("cells"),
            nb::arg("enabled") = true)
    ...
    nb::class_<termin::gui_native::TableModel>(m, "TableModel")
        ...
        .def(
            "row_at",
            [](const termin::gui_native::TableModel& self, size_t index) { return self.row_at(index); },
            nb::arg("index"))
        .def(
            "row",
    ...
    nb::class_<termin::gui_native::TableColumn>(m, "TableColumn")
        ...
        .def(
            "__init__",
            [](termin::gui_native::TableColumn* self,
               std::string stable_id,
               std::string header,
               termin::gui_native::TableColumnPolicy policy,
               float width,
               float min_width,
               float max_width,
               float stretch,
               bool resizable) {
                new (self) termin::gui_native::TableColumn{
                    std::move(stable_id), std::move(header), policy, width, min_width, max_width, stretch, resizable};
            },
            nb::arg("stable_id"),
            nb::arg("header"),
            nb::arg("policy") = termin::gui_native::TableColumnPolicy::Stretch,
            nb::arg("width") = 0.0f,
            nb::arg("min_width") = 40.0f,
            nb::arg("max_width") = 0.0f,
            nb::arg("stretch") = 1.0f,
    ...
    nb::class_<termin::gui_native::TableColumnModel>(m, "TableColumnModel")
        ...
        .def_prop_ro("columns", [](const termin::gui_native::TableColumnModel& self) { return self.columns(); })
        .def(
            "column",
            [](const termin::gui_native::TableColumnModel& self, size_t index) { return self.column(index); },
            nb::arg("index"))
        ...
        .def("insert", &termin::gui_native::TableColumnModel::insert, nb::arg("index"), nb::arg("column"))
        .def("update", &termin::gui_native::TableColumnModel::update, nb::arg("index"), nb::arg("column"))
        .def("resize", &termin::gui_native::TableColumnModel::resize, nb::arg("index"), nb::arg("width"))
    ...
    nb::class_<termin::gui_native::TableColumnLayout>(m, "TableColumnLayout")
        ...
        .def_prop_ro("width", [](const termin::gui_native::TableColumnLayout& self) { return self.width; });

    nb::class_<TreeTableWidgetRef>(m, "TreeTableWidget")
        .def_prop_ro("widget", [](const TreeTableWidgetRef& self) { return self.widget; })
        .def_prop_ro("handle", [](const TreeTableWidgetRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "model",
            [](const TreeTableWidgetRef& self) { return self.get().model(); },
            [](const TreeTableWidgetRef& self, std::shared_ptr<termin::gui_native::TreeTableModel> model) {
                self.get().set_model(std::move(model));
            })
        .def_prop_rw(
            "column_model",
            [](const TreeTableWidgetRef& self) { return self.get().column_model(); },
            [](const TreeTableWidgetRef& self, std::shared_ptr<termin::gui_native::TableColumnModel> columns) {
                self.get().set_column_model(std::move(columns));
            })
        .def_prop_rw(
            "expansion_model",
            [](const TreeTableWidgetRef& self) { return self.get().expansion_model(); },
            [](const TreeTableWidgetRef& self, std::shared_ptr<termin::gui_native::TreeExpansionModel> expansion) {
                self.get().set_expansion_model(std::move(expansion));
            })
        .def_prop_ro("selected_node", [](const TreeTableWidgetRef& self) { return self.get().selected_node(); })
        .def_prop_rw(
            "scroll_y",
            [](const TreeTableWidgetRef& self) { return self.get().scroll_y(); },
            [](const TreeTableWidgetRef& self, float value) { self.get().set_scroll_y(value); })
        .def_prop_ro("content_height", [](const TreeTableWidgetRef& self) { return self.get().content_height(); })
        .def_prop_ro("visible_count", [](const TreeTableWidgetRef& self) { return self.get().visible_count(); })
        .def_prop_ro("visible_range",
                     [](const TreeTableWidgetRef& self) {
                         const auto [first, last] = self.get().visible_range();
                         return std::vector<size_t>{first, last};
                     })
        .def_prop_ro("column_layout", [](const TreeTableWidgetRef& self) { return self.get().column_layout(); })
        .def(
            "visible_row",
            [](const TreeTableWidgetRef& self, size_t index) { return self.get().visible_row(index); },
            nb::arg("index"))
        .def(
            "set_row_height",
            [](const TreeTableWidgetRef& self, float height) { self.get().set_row_height(height); },
            nb::arg("height"))
        .def(
            "set_header_height",
            [](const TreeTableWidgetRef& self, float height) { self.get().set_header_height(height); },
            nb::arg("height"))
        .def(
            "set_indent_size",
            [](const TreeTableWidgetRef& self, float size) { self.get().set_indent_size(size); },
            nb::arg("size"))
        .def(
            "select",
            [](const TreeTableWidgetRef& self, termin::gui_native::TreeTableNodeId node, bool reveal) {
                const bool changed = self.get().select_node(node, reveal);
                self.widget.throw_pending_exception();
                return changed;
            },
        ...
        .def(
            "set_expanded",
            [](const TreeTableWidgetRef& self, termin::gui_native::TreeTableNodeId node, bool expanded) {
                const bool changed = self.get().set_expanded(node, expanded);
                self.widget.throw_pending_exception();
                return changed;
            },
        ...
        .def(
            "toggle",
            [](const TreeTableWidgetRef& self, termin::gui_native::TreeTableNodeId node) {
                const bool changed = self.get().toggle(node);
                self.widget.throw_pending_exception();
                return changed;
            },
        ...
        .def(
            ...
            [](const TreeTableWidgetRef& self, nb::object callback) {
                auto state = self.widget.state;
                return self.get().selection_changed().connect(
                    [state, callback = std::move(callback)](termin::gui_native::TreeTableWidget&,
        ...
        .def(
            ...
            [](const TreeTableWidgetRef& self, nb::object callback) {
                ...
                return self.get().expansion_changed().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::TreeTableWidget&, termin::gui_native::TreeTableNodeId node, bool expanded) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(node, expanded);
                        } catch (...) {
        ...
        .def(
            ...
            [](const TreeTableWidgetRef& self, nb::object callback) {
                ...
                return self.get().column_resized().connect(
                    [state,
                     callback = std::move(callback)](termin::gui_native::TreeTableWidget&, size_t index, float width) {
                        try {
                            nb::gil_scoped_acquire gil;
    ...
    nb::class_<TableWidgetRef>(m, "TableWidget")
        ...
        .def_prop_ro("handle", [](const TableWidgetRef& self) { return WidgetHandle{self.widget.handle}; })
        .def_prop_rw(
            "model",
        ...
        .def_prop_rw(
            ...
            [](const TableWidgetRef& self, std::shared_ptr<termin::gui_native::TableColumnModel> columns) {
                self.get().set_column_model(std::move(columns));
            })
        .def_prop_rw(
            "selection_mode",
        ...
        .def_prop_ro("content_height", [](const TableWidgetRef& self) { return self.get().content_height(); })
        .def_prop_ro("visible_range",
                     [](const TableWidgetRef& self) {
                         const auto [first, last] = self.get().visible_range();
                         return std::vector<size_t>{first, last};
                     })
        .def_prop_ro("column_layout", [](const TableWidgetRef& self) { return self.get().column_layout(); })
        .def(
            "set_row_height",
        ...
        .def(
            ...
            [](const TableWidgetRef& self, nb::object callback) {
                ...
                return self.get().header_clicked().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::TableWidget&, size_t index, const termin::gui_native::TableColumn& column) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, column);
                        } catch (...) {
        ...
        .def(
            ...
            [](const TableWidgetRef& self, nb::object callback) {
                ...
                return self.get().column_resized().connect(
                    [state,
                     callback = std::move(callback)](termin::gui_native::TableWidget&, size_t index, float width) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, width);
                        } catch (...) {
        ...
        .def(
            ...
            [](const TableWidgetRef& self, nb::object callback) {
                ...
                return self.get().context_menu_requested().connect(
                    [state, callback = std::move(callback)](
                        termin::gui_native::TableWidget&, int64_t index, float x, float y) {
                        try {
                            nb::gil_scoped_acquire gil;
                            callback(index, x, y);
                        } catch (...) {
        ...
        .def(
            "disconnect_activated",
            [](const TableWidgetRef& self, size_t connection) { return self.get().activated().disconnect(connection); },
            nb::arg("connection"))
        .def(
            "disconnect_header_clicked",
            [](const TableWidgetRef& self, size_t connection) {
