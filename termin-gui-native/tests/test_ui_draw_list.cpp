...
namespace {
    ...
    private:
        static void paint(tc_widget* widget, tc_ui_document_handle, tc_ui_paint_context* context) {
            ...
            tc_ui_painter_fill_rect(
                context, tc_ui_rect{1.0f, 2.0f, 30.0f, 10.0f}, tc_ui_srgb_color{0.1f, 0.2f, 0.3f, 1.0f});
            tc_ui_painter_draw_line(context,
                                    tc_ui_point{4.0f, 5.0f},
                                    tc_ui_point{6.0f, 7.0f},
                                    tc_ui_srgb_color{0.8f, 0.7f, 0.6f, 1.0f},
                                    2.0f);
    ...
    void test_renderer_font_binds_document_text_measurement() {
        ...
        assert(document.set_presentation_metrics(tc_ui_presentation_metrics_identity(tc_ui_size{800.0f, 600.0f})));
    ...
    void test_extended_commands_own_variable_data_and_preserve_legacy_values() {
        ...
        const tc_ui_arc_draw_desc arc{tc_ui_point{14.0f, 15.0f}, 7.0f, 0.25f, 2.5f, white, 2.0f, 12};
        ...
        const tc_ui_uniform_transform transform{{10.0f, 20.0f}, 2.0f};
        assert(tc_ui_uniform_transform_is_valid(&transform));
        ...
        assert(push_transform && push_transform->type == TC_UI_DRAW_PUSH_UNIFORM_TRANSFORM);
