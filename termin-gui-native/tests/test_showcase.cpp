...
namespace {
    ...
    bool
    measure_test_text(void*, const char* text, size_t byte_length, float font_size, tc_ui_text_metrics* out_metrics) {
    ...
    void test_showcase_builds_stable_headless_snapshot() {
        ...
        require_equal(tc_ui_draw_list_command_count(draw_list), 229, "showcase total commands");
        ...
        require_equal(count_commands(draw_list, TC_UI_DRAW_TEXT), 56, "showcase text commands");
