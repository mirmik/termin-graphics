...
namespace {
    ...
    void test_snapshot_copies_topology_metadata_and_interaction_state() {
        ...
        const tc_widget_handle root_handle = tc_ui_document_attach_borrowed_widget(document.get(), &root.widget);
        const tc_widget_handle child_handle = tc_ui_document_attach_borrowed_widget(document.get(), &child.widget);
        const tc_widget_handle overlay_handle = tc_ui_document_attach_borrowed_widget(document.get(), &overlay.widget);
        ...
        assert(tc_ui_document_show_overlay(
            document.get(), overlay_handle, TC_UI_OVERLAY_POINTER_TRANSPARENT | TC_UI_OVERLAY_TOOLTIP));
        ...
        assert(snapshot.overlays()[0].flags == (TC_UI_OVERLAY_POINTER_TRANSPARENT | TC_UI_OVERLAY_TOOLTIP));
