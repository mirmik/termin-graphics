...
namespace termin::gui_native {
    ...
    tc_ui_style NativeWidget::computed_style(tc_ui_document_handle document, uint32_t extra_state_flags) const {
        tc_ui_style style{};
    ...
    tc_ui_size NativeWidget::measure(tc_ui_document_handle, tc_ui_constraints constraints) {
        ...
        const tc_ui_size preferred{preferred_size().width > 0.0f ? preferred_size().width : min_size().width,
    ...
    tc_ui_size
    NativeWidget::dispatch_measure(tc_widget* widget, tc_ui_document_handle document, tc_ui_constraints constraints) {
    ...
    void NativeWidget::dispatch_paint(tc_widget* widget, tc_ui_document_handle document, tc_ui_paint_context* context) {
        auto* self = static_cast<NativeWidget*>(widget ? widget->body : nullptr);
        if (self) {
    ...
    tc_ui_event_result NativeWidget::dispatch_pointer_event(tc_widget* widget,
    ...
    tc_widget_handle
    NativeWidget::dispatch_hit_test(tc_widget* widget, tc_ui_document_handle document, float x, float y) {
        auto* self = static_cast<NativeWidget*>(widget ? widget->body : nullptr);
        return self ? self->hit_test(document, x, y) : tc_widget_handle_invalid();
    }

    tc_ui_event_result
    NativeWidget::dispatch_key_event(tc_widget* widget, tc_ui_document_handle document, const tc_ui_key_event* event) {
        auto* self = static_cast<NativeWidget*>(widget ? widget->body : nullptr);
        return self ? self->key_event(document, event) : TC_UI_EVENT_IGNORED;
    }

    tc_ui_event_result NativeWidget::dispatch_text_event(tc_widget* widget,
                                                         tc_ui_document_handle document,
    ...
    void NativeWidget::dispatch_focus_event(tc_widget* widget, tc_ui_document_handle document, bool focused) {
        auto* self = static_cast<NativeWidget*>(widget ? widget->body : nullptr);
        if (self) {
    ...
    void NativeWidget::dispatch_descendant_focused(tc_widget* widget,
                                                   tc_ui_document_handle document,
    ...
    void NativeWidget::dispatch_overlay_dismissed(tc_widget* widget,
                                                  tc_ui_document_handle document,
