...
namespace termin::gui_native {
    ...
    bool InputDialog::ensure_content(tc_ui_document_handle document) {
        if (!tc_widget_handle_is_invalid(input_handle_) && tc_ui_document_is_alive(document, input_handle_)) {
            return true;
        }
        ...
        const tc_widget_handle column_handle =
            tc_ui_document_adopt_widget(document, column->c_widget(), &Widget::delete_owned_widget);
        const tc_widget_handle label_handle =
            tc_ui_document_adopt_widget(document, label->c_widget(), &Widget::delete_owned_widget);
        const tc_widget_handle input_handle =
            tc_ui_document_adopt_widget(document, input->c_widget(), &Widget::delete_owned_widget);
