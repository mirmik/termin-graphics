 ...
 */
TERMIN_MATERIALS_API bool tc_surface_contract_registry_register(const char* owner,
 ...
 */
TERMIN_MATERIALS_API const tc_surface_contract_desc* tc_surface_contract_registry_find(tc_surface_contract_key key);
TERMIN_MATERIALS_API const char* tc_surface_contract_registry_owner(tc_surface_contract_key key);
 ...
 */
TERMIN_MATERIALS_API bool tc_surface_contract_registry_unregister(const char* owner, tc_surface_contract_key key);
TERMIN_MATERIALS_API size_t tc_surface_contract_registry_unregister_owner(const char* owner);

TERMIN_MATERIALS_API size_t tc_surface_contract_registry_count(void);
TERMIN_MATERIALS_API const tc_surface_contract_desc* tc_surface_contract_registry_at(size_t index);
